...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      workflowdocument: ['WFRes/assets/stylesheets/themes.min.css',
                            ...
                            'WFRes/_Scripts/designer/WorkflowDocument.js?20190910',
      ...
      SheetWorkflow: ['WFRes/_Content/themes/ligerUI/Aqua/css/ligerui-all.css',
          ...
          'WFRes/_Scripts/MvcSheet/SheetControls.js?' + versionDZ,
          'WFRes/_Scripts/MvcSheet/MvcSheetUI.js?' + versionDZ,
          'WFRes/_Scripts/MvcSheet/Controls/SheetWorkflow.js?' + versionDZ],
      SheetUser: [      'WFRes/_Content/themes/ligerUI/Aqua/css/ligerui-all.css',
          ...
          'WFRes/_Scripts/MvcSheet/SheetControls.js?' + versionDZ,
          'WFRes/_Scripts/MvcSheet/MvcSheetUI.js?' + versionDZ,
          'WFRes/_Scripts/MvcSheet/Controls/SheetUser.js?' + versionDZ]
  })
  .constant('ControllerConfig', {
      ...
      WorkItem: {
          ...
          GetUnfinishWorkItems: "WorkItemHandler/GetUnfinishWorkItems",//待办          

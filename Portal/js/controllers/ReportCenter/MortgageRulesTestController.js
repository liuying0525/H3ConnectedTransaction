app.controller('MortgageRulesTestController', ['$scope', "$rootScope", "$translate", "$timeout", "$compile",
    ...
    function ($scope, $rootScope, $translate, $timeout, $compile, $http, $state, $stateParams, $filter, ControllerConfig) {
        ...
        $scope.search = function (page) {
            $http({
                method: 'post',
                url: '/Portal/Ajax/GetMortageRules.ashx?Page=' + (page - 1) + '&Size=' + $scope.Size + '&Shop=' + $scope.SearchKey.Shop + '&Province=' + $scope.SearchKey.Province + '&City=' + $scope.SearchKey.City + '&SpName=' + $scope.SearchKey.SpName + '&DyName=' + $scope.SearchKey.DyName,
        ...
        $scope.getCity = function (id) {
            $http({
                method: 'post',
                url: '/Portal/Ajax/GetMortageRules.ashx?method=GetProvince' + '&id=' + id,
            }).success(function (req) {
                $scope.City = req;

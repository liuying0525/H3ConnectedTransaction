            ...
            <div class="row">
             ...
             <div class="row">
				...
				<div id="Div3" class="col-md-4">
					<input id="Text1" type="text" data-datafield="fkResult" data-type="SheetTextBox" style="">
				</div>
                </div>
            <div class="row">
...
<div class="row">
                ...
                <div class="row">
                    <div id="title387" class="col-md-2">
                        <span id="Label355" data-type="SheetLabel" data-datafield="KHKKSQS" style="">扣款授权书</span>
                    </div>
      ...
      function yzlth(ts) {
       ...
       //银行卡数字验证
        ...
        $.MvcSheet.Validate = function () {
            var Activity = '<%=this.ActionContext.ActivityCode%>';
            if (this.Action == "Submit" && Activity == 'Activity48') {
        ...
        $.MvcSheet.PreInit = function () {
            ...
            if (submitActivities.length > 1) {
                ...
                $.ajax({
                    type: "post",
                    //url: "../../../ajax/WorkItemHandler.ashx?CommandName=getLastWorkItem&id=" + $.MvcSheetUI.SheetInfo.WorkItemId,

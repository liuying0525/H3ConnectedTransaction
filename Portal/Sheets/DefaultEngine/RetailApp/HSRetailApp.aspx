<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HSRetailApp.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.HSRetailApp" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<span class="OnlyDesigner">Originator.OUName</span>
            ...
            <div class="row tableContent">
                <div id="title445" class="col-md-2">
                    <span id="Label398" data-type="SheetLabel" data-datafield="LY" style="" class="">留言信息</span>
                </div>
                <div id="control445" class="col-md-10">
                    <table id="Control398" data-datafield="LY" data-type="SheetGridView" class="SheetGridView"">
                        <tbody>
                            <tr class="header">
                                <td id="Control398_SerialNo" class="rowSerialNo">序号</td>
                                <td id="Control398_Header3" data-datafield="LY.LYxx">
                                    <label id="Control398_Label3" data-datafield="LY.LYxx" data-type="SheetLabel" style="">留言内容</label>
                                </td>
                                <td id="Control398_Header4" data-datafield="LY.LYRY">
                                    <label id="Control398_Label4" data-datafield="LY.LYRY" data-type="SheetLabel" style="">留言人员</label>
                                </td>
                                <td id="Control398_Header5" data-datafield="LY.LYSJ">
                                    <label id="Control398_Label5" data-datafield="LY.LYSJ" data-type="SheetLabel" style="">留言时间</label>
                                </td>
                                <td class="rowOption">删除</td>
                            </tr>
                            <tr class="template">
                                <td id="Control398_Option" class="rowOption"></td>
                                <td data-datafield="LY.LYxx">
                                    <input id="Control398_ctl3" type="text" data-datafield="LY.LYxx" data-type="SheetTextBox" style=""/>
                                </td>
                                <td data-datafield="LY.LYRY">
                                    <input id="Control398_ctl4" type="text" data-datafield="LY.LYRY" data-type="SheetTextBox" style=""/>
                                </td>
                                <td data-datafield="LY.LYSJ">
                                    <input id="Control398_ctl5" type="text" data-datafield="LY.LYSJ" data-type="SheetTextBox" style=""/>
                                </td>
                                <td class="rowOption">
                                    <a class="delete">
                            ...
                            <tr class="footer">
                                ...
                                <td data-datafield="LY.LYxx"></td>
                                <td data-datafield="LY.LYRY"></td>
                                <td data-datafield="LY.LYSJ"></td>
                                <td class="rowOption"></td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="divContent" id="divSQR">
            ...
            <div id="divBascSQRInfo">
                <div class="row">
                    <div class="col-md-2">
                        <span data-type="SheetLabel" style="">风控模型评估</span>
                    </div>
                    <div class="col-md-2">
                        <span><a href="javascript:void(0);" onclick="rsfkClick();"  target="_blank">评估结果</a></span>
                    </div>
                    <div class="col-md-2">
                        <span><a target="_blank" href="javascript:void(0);" onclick="nciicClick();">NCIIC</a></span>
                    </div>
                    <div class="col-md-6">
                        <label>PBOC</label>
                        <a href="javascript:void(0);" onclick="pbocClick();" target="_blank">申请人</a>
                        <a href="javascript:void(0);" onclick="pbocClick();" target="_blank">共借人</a>
                        <a href="javascript:void(0);" onclick="pbocClick();" target="_blank">担保人</a>
        ...
        <div class="divContent" id="divGJR">
            ...
            <div id="divBascSQRInfo1">
                ...
                <div class="row">
                    ...
                    <div id="control129" class="col-md-10">
        ...
        <div class="divContent" id="divJRTK">
            ...
            <div class="row">
				...
				<select data-datafield="Bankname" data-type="SheetDropDownList" id="ctl64724" class="" style="" data-masterdatacategory="银行" data-schemacode="yhld" data-querycode="yhld" data-filter="0:PARENTCODE" data-datavaluefield="BANKCODE" data-datatextfield="BANKNAME"></select></div>
				...
				<select data-datafield="Branchname" data-type="SheetDropDownList" id="ctl875733" class="" style="" data-schemacode="yhld" data-querycode="yhld" data-filter="Bankname:PARENTCODE" data-datavaluefield="BANKCODE" data-datatextfield="BANKNAME"></select></div>
			</div>
            <div class="row">
                ...
                <div id="title410" class="col-md-2">
                    <span id="Label369" data-type="SheetLabel" data-datafield="AccoutNumber" style="">客户账户号</span>
                </div>
            ...
            <div class="row tableContent">
                <div id="title359" class="col-md-2">
                    <span id="Label341" data-type="SheetLabel" data-datafield="hRentalDetailtable" style="">还款计划</span>
                </div>
                <div id="control359" class="col-md-10">
                    <table id="Control341" data-datafield="hRentalDetailtable" data-type="SheetGridView" class="SheetGridView">
                        <tbody>

                            <tr class="header">
                                <td id="Control341_SerialNo" class="rowSerialNo">序号								</td>
                                <td id="Control341_Header3" data-datafield="hRentalDetailtable.startTerm">
                                    <label id="Control341_Label3" data-datafield="hRentalDetailtable.startTerm" data-type="SheetLabel" style="">还款起始期</label>
                                </td>
                                <td id="Control341_Header4" data-datafield="hRentalDetailtable.endTerm">
                                    <label id="Control341_Label4" data-datafield="hRentalDetailtable.endTerm" data-type="SheetLabel" style="">还款结束期</label>
                                </td>
                                <td id="Control341_Header5" data-datafield="hRentalDetailtable.rentalAmount">
                                    <label id="Control341_Label5" data-datafield="hRentalDetailtable.rentalAmount" data-type="SheetLabel" style="">还款额</label>
                                </td>
                                <td id="Control341_Header6" data-datafield="hRentalDetailtable.grossRentalAmount">
                                    <label id="Control341_Label6" data-datafield="hRentalDetailtable.grossRentalAmount" data-type="SheetLabel" style="">每期还款总额</label>
                                </td>
                                <td class="rowOption">删除								</td>
                            </tr>
                            <tr class="template">
                                <td id="Control341_Option" class="rowOption"></td>
                                <td data-datafield="hRentalDetailtable.startTerm">
                                    <input id="Control341_ctl3" type="text" data-datafield="hRentalDetailtable.startTerm" data-type="SheetTextBox" style="">
                                </td>
                                <td data-datafield="hRentalDetailtable.endTerm">
                                    <input id="Control341_ctl4" type="text" data-datafield="hRentalDetailtable.endTerm" data-type="SheetTextBox" style="">
                                </td>
                                <td data-datafield="hRentalDetailtable.rentalAmount">
                                    <input id="Control341_ctl5" type="text" data-datafield="hRentalDetailtable.rentalAmount" data-type="SheetTextBox" style="">
                                </td>
                                <td data-datafield="hRentalDetailtable.grossRentalAmount">
                                    <input id="Control341_ctl6" type="text" data-datafield="hRentalDetailtable.grossRentalAmount" data-type="SheetTextBox" style="">
                                </td>
                                <td class="rowOption">
                                    <a class="delete">
                                        <div class="fa fa-minus">
                            ...
                            <tr class="footer">
                                <td class="rowOption"></td>
                                <td data-datafield="hRentalDetailtable.startTerm"></td>
                                <td data-datafield="hRentalDetailtable.endTerm"></td>
                                <td data-datafield="hRentalDetailtable.rentalAmount"></td>
                                <td data-datafield="hRentalDetailtable.grossRentalAmount"></td>
                                <td class="rowOption"></td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <div id="example" class="modal fade in" aria-hidden="true">
        ...
        <div class="modal-body">
            <table class="SheetGridView">
                 <thead>
                     <tr class="header">
                         <td id="" class="rowSerialNo">序号</td>
                         <td id="">
                             <label id="" style="">申请号</label>
                         </td>
                         <td id="">
                             <label id="" style="">贷款类型</label>
                         </td>
                         <td id="">
                             <label id="" style="">申请人</label>
                         </td>
                         <td id="">
                             <label id="" style="">贷款金额</label>
                         </td>
                     </tr>  
                 </thead>
        ...
        <div class="modal-footer" style="position:absolute;right:0;top:250px;width:100%;height:50px;">
    ...
    <script type="text/javascript">
        ...
        function getDownLoadURL() {
            if ($("#ulfjll").find("li").length > 0) {
                if ($("#ulfjll").css("display") == "none") {
                    $("#ulfjll").css("display", "block");
                } else {
                    $("#ulfjll").css("display", "none");
                }
        ...
        function getCkje() {
            ...
            var currentV = $("#ctrlfinancedamount").val();
            var datajson = { CommandName: "indvidualHistoryFinancedAmount", IdCardNo: IdCardNo, applicationno: applicationno, currentV: currentV };
            $.ajax({
                //url: "../../../ajax/DZBizHandler.ashx",
                url: "/Portal/DZBizHandler/indvidualHistoryFinancedAmount",// 19.6.28 wangxg
                data: { CommandName: "indvidualHistoryFinancedAmount", IdCardNo: IdCardNo, applicationno: applicationno, currentV: currentV },
                type: "POST",
                async: false,
                dataType: "json",
            ...
            $.ajax({
                //url: "../../../ajax/DZBizHandler.ashx",
                url: "/Portal/DZBizHandler/getIndvidualApplicationHistory",// 19.6.28 wangxg
                data: { CommandName: "getIndvidualApplicationHistory", IdCardNo: IdCardNo, applicationno: applicationno },
                type: "POST",
                async: false,
                dataType: "text",
                success: function (result) {
                    ...
                    for (var i = 0; i < request.length; i++) {
                        ...
                        var j = i + 1;
                        tr += "<td>" + j + "</td>";
                        tr += "<td><a href=\"../../../InstanceSheets.html?InstanceId=" + request[i].INSTANCEID + "\" target=\"_blank\">" + request[i].APPLICATIONNO + "</a></td>";
                        var APPLICATIONTYPE = request[i].APPLICATIONTYPE == "RetailApp" ? "个人贷款" : "机构贷款";
                        tr += "<td>" + APPLICATIONTYPE + "</td>";
                        tr += "<td>" + request[i].THAIFIRSTNAME + "</td>";
                        tr += "<td>" + request[i].FINANCEDAMOUNT + "</td>";
                        tr += "</tr>";
        ...
        function pbocClick() {
            ...
            //var pbocurl = "http://1926423ea3.iask.in:14502/request/report";
            var pbocurl = '<%=ConfigurationManager.AppSettings["pbocurl"] + string.Empty%>';
            var IdCardNo = $("#ctrlIdCardNo").val();
            var username = $("input[data-datafield='ThaiFirstName']").val();
            var username = $("input[data-datafield='ThaiFirstName']").val();
            var datajson = "{ \"reportRequest\": { \"repID\": \"999999999999999999993\", \"name\": \"张李五\", \"idtype\": \"0\", \"id\": \"110108195805175419\", \"time\": \"2017-12-12\", \"operator\": \"zxs\" } }";
            $.ajax({
                url: pbocurl,
                data: datajson,
                type: "POST",
        ...
        function rsfkClick() {
            ...
            //var rsfkurl = encodeURI("http://1926423ea3.iask.in:14502/request/result");
            var rsfkurl = '<%=ConfigurationManager.AppSettings["rsfkurl"] + string.Empty%>';
            var url = "../view/rsfkresult.html?&Control29=" + Control29 + "&Control122=" + Control122 + "&Control209=" + Control209 + "&rsfkurl=" + rsfkurl;
        ...
        function nciicClick() {
            var instanceid = '<%=this.ActionContext.InstanceId%>';
            //alert(instanceid);
            //var nciicurl = encodeURI("http://1926423ea3.iask.in:14502/request/result");
            var nciicurl ='<%=ConfigurationManager.AppSettings["nciicurl"] + string.Empty%>';
            var url = "../view/NCIIC.html?&nciicurl=" + nciicurl + "&instanceid=" + instanceid;
            var paramas = "";
            paramas += "&zjrsfz=" + $("input[data-datafield='IdCardNo']").val();
            paramas += "&zjrxm=" + $("input[data-datafield='ThaiFirstName']").val();
            paramas += "&zjrcym=" + $("input[data-datafield='FormerName']").val();
            paramas += "&zjrxb=" + $("input[data-datafield='genderName']").val();
            paramas += "&zjrmz=" + $("input[data-datafield='NationName']").val();
            paramas += "&zjrcrrq=" + $("input[data-datafield='DateOfBirth']").val();
            paramas += "&zjrwhcd=" + $("input[data-datafield='EducationName']").val();
            paramas += "&zjrhyzk=" + $("input[data-datafield='MaritalStatusName']").val();
            paramas += "&zjrfwcs=" + $("textarea[data-datafield='companyAddress']").val();
            paramas += "&zjrcsdssx=" + $("input[data-datafield='birthpalaceprovince']").val();
            paramas += "&zjrjgssx=" + $("input[data-datafield='nativedistrict']").val();
            paramas += "&zjrssssx=" + $("input[data-datafield='hukouprovinceName']").val() + $("input[data-datafield='hukoucityName']").val();
            paramas += "&zjrzz=" + $("textarea[data-datafield='currentLivingAddress']").val();

            paramas += "&gjrsfz=" + $("input[data-datafield='GjIdCardNo']").val();
            paramas += "&gjrxm=" + $("input[data-datafield='GjThaiFirstName']").val();
            paramas += "&gjrcym=" + $("input[data-datafield='GjFormerName']").val();
            paramas += "&gjrxb=" + $("input[data-datafield='GjgenderName']").val();
            paramas += "&gjrmz=" + $("input[data-datafield='GjNationName']").val();
            paramas += "&gjrcrrq=" + $("input[data-datafield='GjDateOfBirth']").val();
            paramas += "&gjrwhcd=" + $("input[data-datafield='GjEducationName']").val();
            paramas += "&gjrhyzk=" + $("input[data-datafield='GjMaritalStatusName']").val();
            paramas += "&gjrfwcs=" + $("textarea[data-datafield='GjcompanyAddress']").val();
            paramas += "&gjrcsdssx=" + $("input[data-datafield='Gjbirthpalaceprovince']").val();
            paramas += "&gjrjgssx=" + $("input[data-datafield='Gjnativedistrict']").val();
            paramas += "&gjrssssx=" + $("input[data-datafield='GjhukouprovinceName']").val() + $("input[data-datafield='GjhukoucityName']").val();
            paramas += "&gjrzz=" + $("textarea[data-datafield='GjcurrentLivingAddress']").val();

            paramas += "&bdrsfz=" + $("input[data-datafield='DbIdCardNo']").val();
            paramas += "&bdrxm=" + $("input[data-datafield='DbThaiFirstName']").val();
            paramas += "&bdrcym=" + $("input[data-datafield='DbFormerName']").val();
            paramas += "&bdrxb=" + $("input[data-datafield='DbgenderName']").val();
            paramas += "&bdrmz=" + $("input[data-datafield='DbNationCode']").val();
            paramas += "&bdrcrrq=" + $("input[data-datafield='DbDateOfBirth']").val();
            paramas += "&bdrwhcd=" + $("input[data-datafield='DbEducationName']").val();
            paramas += "&bdrhyzk=" + $("input[data-datafield='DbMaritalStatusName']").val();
            paramas += "&bdrfwcs=" + $("textarea[data-datafield='DbcompanyAddress']").val();
            paramas += "&bdrcsdssx=" + $("input[data-datafield='Dbbirthpalaceprovince']").val();
            paramas += "&bdrjgssx=" + $("input[data-datafield='Dbnativedistrict']").val();
            paramas += "&bdrssssx=" + $("input[data-datafield='DbhukouprovinceName']").val() + $("input[data-datafield='DbhukoucityName']").val();
            paramas += "&bdrzz=" + $("textarea[data-datafield='DbcurrentLivingAddress']").val();
            paramas += "&nciicurl=" + nciicurl;
            //url += encodeURI(paramas);
            //alert(paramas);
            //window.open("../view/NCIIC.html");
            //localStorage.nciicparamas = paramas;
            //window.postMessage(paramas,"http://172.16.10.75:8010/Portal/Sheets/DefaultEngine/view/NCIIC.html")
            $("#aclick").attr("href", url);
            document.getElementById("aclick").click();
            return false;
        }

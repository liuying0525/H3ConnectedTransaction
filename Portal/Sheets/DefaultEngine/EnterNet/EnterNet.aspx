...
<asp:Content ID="head" ContentPlaceHolderID="headContent" runat="Server">
    ...
    <script type="text/javascript">
        var enterneturl = '<%=ConfigurationManager.AppSettings["enterneturl"] + string.Empty%>';
    </script>
</asp:Content>
...
<asp:Content ID="master" ContentPlaceHolderID="masterContent" runat="Server">
    ...
    <div class="panel-body sheetContainer">
        ...
        <div class="divContent" id="divSheet">
            ...
            <div class="nav-icon fa  fa-chevron-right bannerTitle">
                <label id="divSheetInfo" data-en_us="Sheet information">贷款银行开户信息</label>
            </div>
            <div class="divContent" id="divSheet">
                <div class="row">
            ...
            <div class="divContent" id="divSheet">
                <div class="row tableContent">
                    ...
                    <div id="control27" class="col-md-10">
                        <table id="Control35" data-datafield="ContactInformation" data-type="SheetGridView" class="SheetGridView" style="width:100%">
                            <tbody>
                                ...
                                <tr class="header">
                                    ...
                                    <td id="Control35_Header7" data-datafield="ContactInformation.PositionInputName">
                                        <label id="Control35_Label7" data-datafield="ContactInformation.PositionInputName" data-type="SheetLabel" style="">具体职位</label>
                                    </td>
                                    <td id="Control35_Header8" data-datafield="ContactInformation.IsMainReceiver">
                                        <label id="Control35_Label8" data-datafield="ContactInformation.IsMainReceiver" data-type="SheetLabel" style="">放款短信接收人</label>
                                    </td>
                                    <td class="rowOption">
                                        删除
                                    </td>
                                ...
                                <tr class="template">
                                    ...
                                    <td data-datafield="ContactInformation.PositionInputName">
                                        <input id="Control35_ctl7" type="text" data-datafield="ContactInformation.PositionInputName" data-type="SheetTextBox" style="">
                                    </td>
                                    <td data-datafield="ContactInformation.IsMainReceiver">
                                        <input id="Control35_ctl8" type="text" data-datafield="ContactInformation.IsMainReceiver" data-type="SheetTextBox" style="">
                                    </td>
                                    <td class="rowOption">
                                        <a class="delete">
            ...
            <div class="arealeader">
                <div class="nav-icon fa  fa-chevron-right bannerTitle">
                    <label  data-en_us="Sheet information">省区经理审批</label>
                </div>
                <div class="divContent" >
                    <div class="row">
                        <div id="title119" class="col-md-2">
                            <span id="Label119" data-type="SheetLabel" style="" class="">审批结果</span>
                        </div>
                        <div id="contro119" class="col-md-4">

                            <select data-datafield="arearesult" data-type="SheetDropDownList" id="ctl476621" class="" style="" data-defaultitems="同意;不同意"></select>
                        </div>
                        <div id="title120" class="col-md-2">
                        </div>
                        <div id="control120" class="col-md-4">
                        </div>
                    </div>
                    <div class="row tableContent">
                        <div id="title121" class="col-md-2">
                            <span id="Label121" data-type="SheetLabel"  style="" class="">审批意见</span>
                        </div>
                        <div id="control121" class="col-md-10">
                            <div id="Control18" data-datafield="areaadvise" data-type="SheetComment" style="" class=""></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="risk_cs">
                <div class="nav-icon fa  fa-chevron-right bannerTitle">
                    <label id="divSheetInfo" data-en_us="Sheet information">风险初审</label>
                </div>
                <div class="divContent" id="divSheet">
                    <div class="row">
                        <div id="title85" class="col-md-2">
                            <span id="Label82" data-type="SheetLabel" data-datafield="risk_cs_result" style="" class="">审批结果</span>
                        </div>
                        <div id="control84" class="col-md-4">
                            <select data-datafield="risk_cs_result" data-type="SheetDropDownList" id="ctl535398" class="" style="" data-defaultitems="同意;不同意"></select>
                        </div>
                        <div id="space73" class="col-md-2">
                        </div>
                        <div id="spaceControl73" class="col-md-4">
                    ...
                    <div class="row tableContent">
                        <div id="title74" class="col-md-2">
                            <span id="Label75" data-type="SheetLabel" data-datafield="risk_cs_advice" style="" class="">审批意见</span>
                        </div>
                        <div id="control74" class="col-md-10">
                            <textarea data-datafield="risk_cs_advice" style="height: 60px; width: 100%;" data-type="SheetRichTextBox" id="ctl43451" class=""></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div id="title66" class="col-md-2">
                            <span id="Label72" data-type="SheetLabel" data-datafield="risk_cs_doc" style="" class="">风险初审附件</span>
                        </div>
                        <div id="control65" class="col-md-10">
                            <div id="Control72" data-datafield="risk_cs_doc" data-type="SheetAttachment" style="" class=""></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="xxzs">
                ...
                <div class="divContent" id="divSheet">
                    ...
                    <div class="row xxzsxyresult">
                        <div id="title109" class="col-md-2">
                            <span id="Label109" data-type="SheetLabel" data-datafield="AgreementResult" style="">协议审核结果</span>
                        </div>
                        <div id="control109" class="col-md-4">
                            <select data-datafield="AgreementResult" data-type="SheetDropDownList" id="Control109" class="" style="" data-defaultitems="同意;不同意"></select>
                        </div>
                        <div id="space110" class="col-md-2">
                        </div>
                        <div id="spaceControl110" class="col-md-4">
                        </div>
                    </div>
                    <div class="row">
                        <div id="title79" class="col-md-2">
                            <span id="Label78" data-type="SheetLabel" data-datafield="AgreementOpinion" style="">协议审核意见</span>
                        </div>
                        <div id="control79" class="col-md-10">
                            <textarea data-datafield="AgreementOpinion" style="height: 60px; width: 100%;" data-type="SheetRichTextBox" id="Control111" class=""></textarea>
                        </div>
                    </div>
                    <div class="row xxzszh">
                        ...
                        <div class="col-md-4" id="spaceControl82">
                            <%--<input id="ctl722372" type="text" data-type="SheetTextBox" data-datafield="FinancialCode" onblur="$.ajax({type: &quot;Post&quot;,url:&quot;/Portal/ajax/FinancialCodeSearch.ashx?code=&quot; + $.MvcSheetUI.GetControlValue(&quot;FinancialCode&quot;) + &quot;&amp;objectid=&quot; + $.MvcSheetUI.SheetInfo.BizObject.DataItems[&quot;ObjectID&quot;].V,success: function(g) {if(g == &quot;1&quot;)alert('财务编码重复，请重新输入！');}});">--%>
                            <input id="ctl722372" type="text" data-type="SheetTextBox" data-datafield="FinancialCode" onblur="$.ajax({type: &quot;Post&quot;,url:&quot;/Portal/FinancialCodeSearch/Index?code=&quot; + $.MvcSheetUI.GetControlValue(&quot;FinancialCode&quot;) + &quot;&amp;objectid=&quot; + $.MvcSheetUI.SheetInfo.BizObject.DataItems[&quot;ObjectID&quot;].V,success: function(g) {if(g == &quot;1&quot;)alert('财务编码重复，请重新输入！');}});">
                        </div>
                    </div>
    ...
    <script type="text/javascript">
	    ...
	    $.MvcSheetUI.SetControlValue('CurrentUser', $.MvcSheetUI.SheetInfo.UserName);
            ...
            if ($.MvcSheetUI.SheetInfo.ActivityCode == "Activity2") {
                $(".arealeader,.xscs,.xszs,.xxcs,.xxfs,.risk_cs,.xxzs").hide();
            }
            if ($.MvcSheetUI.SheetInfo.ActivityCode == "Activity57") {
                $(".xscs,.xszs,.xxcs,.xxfs,.risk_cs,.xxzs").hide();
            }
            if ($.MvcSheetUI.SheetInfo.ActivityCode == "Activity3") {
                $(".xszs,.xxcs,.xxfs,.risk_cs,.xxzs").hide();
            }
            if ($.MvcSheetUI.SheetInfo.ActivityCode == "Activity10") {
                $(".xxcs,.xxfs,.risk_cs,.xxzs").hide();
            }
            if ($.MvcSheetUI.SheetInfo.ActivityCode == "Activity11") {
                $(".xxfs,.risk_cs,.xxzs").hide();
            }
            if ($.MvcSheetUI.SheetInfo.ActivityCode == "Activity12") {
                $(".risk_cs,.xxzs").hide();
            }
            if ($.MvcSheetUI.SheetInfo.ActivityCode == "Activity53") {
                $(".xxzs").hide();
            }
            ...
            if ($.MvcSheetUI.SheetInfo.ActivityCode == "Activity19") {
                ...
                $.MvcSheet.Submit = function (actionControl, text, destActivity, postValue, groupValue) {
                    ...
                    $.ajax({
                        async:false,
                        type: "Post",
                        //url:"/Portal/ajax/FinancialCodeSearch.ashx?code=" + $.MvcSheetUI.GetControlValue("FinancialCode") + "&objectid=" + $.MvcSheetUI.SheetInfo.BizObject.DataItems["ObjectID"].V,
                        url:"/Portal/FinancialCodeSearch/Index?code=" + $.MvcSheetUI.GetControlValue("FinancialCode") + "&objectid=" + $.MvcSheetUI.SheetInfo.BizObject.DataItems["ObjectID"].V,
                        success: function (g) {
                            if (g == "1") {
                                iscontinue = true;
                                alert('财务编码重复，请重新输入！');
            ...
            for (var i = 0; i < $files.length; i++) {
                ...
                values = htmDecode(values);
                console.log(values);
                if (values != "" && values != null) {
                    if (values.indexOf("<>") > -1) {
                        var val = values.split("<>");
                        for (var j = 0; j < val.length; j++) {
                            $t.after("<a href='" + enterneturl + val[j].split(">")[1] + "' target='_blank'>" + val[j].split(">")[0] + "</a><br/>");
                        }
                    } else {
                        $t.after("<a href='" + enterneturl + values.split(">")[1] + "' target='_blank'>" + values.split(">")[0] + "</a>");
                    }
                }
            }
            //$("[data-downloadfile]").attr("href", "/Portal/ajax/EnterNetAttachment.ashx?objectId=" + $.MvcSheetUI.SheetInfo.BizObjectID);
            $("[data-downloadfile]").attr("href", "/Portal/EnterNetAttachment/Index?objectId=" + $.MvcSheetUI.SheetInfo.BizObjectID);
        ...
        $.MvcSheet.Validate = function () {  
            if ($.MvcSheetUI.SheetInfo.ActivityCode == "Activity12"
                || $.MvcSheetUI.SheetInfo.ActivityCode == "Activity13"
                || $.MvcSheetUI.SheetInfo.ActivityCode == "Activity16")
            {
                if (this.Action == "Submit")
                {
                    var loan = $.MvcSheetUI.GetControlValue("VerifyLoan", 1);
                    var isNumber = Number(loan);
                    if (isNaN( isNumber)) {
                        shakeMsg('放款额度必须输入数字');
                        return false;
                    }

...
<asp:Content ID="master" ContentPlaceHolderID="masterContent" runat="Server">
    ...
    <div class="panel-body sheetContainer">
                        ...
                        <div id="myTabContent_ctl604410" class="tab-content">
                            <div class="template">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data71" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL.JOB_GROUP_CDE" data-type="SheetDropDownList" id="ctl604410_control71" style="" data-queryable="false"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data45" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL.ID_CARDISSUE_DTE" data-type="SheetTime" id="ctl604410_control45" style=""
                                                data-defaultvalue="" data-onchange="id_card_date_chg(this)" data-minvalue="1900-01-01" data-maxvalue="2100-01-01">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data46" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL.ID_CARDEXPIRY_DTE" data-type="SheetTime" id="ctl604410_control46" style="" data-defaultvalue=""
                                                data-onchange="id_card_date_chg(this)" data-minvalue="1900-01-01" data-maxvalue="2100-01-01">
                                        </div>
                                    </div>
                                ...
                                <div class="row bottom">
                                    ...
                                    <div class="col-md-4" style="padding-bottom: 0px!important; margin-bottom: 0px!important; border-bottom: 1px solid #ccc!important;">
                                        ...
                                        <div id="ctl604410_Data74" class="col-md-6">
                            ...
                            <div class="template">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data34" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL.ORGANIZATION_CDE" data-type="SheetTextBox" id="ctl863190_control34" style=""
                                                 maxlength="18" onkeyup="this.value=strMaxLength(this.value,'25')" data-onchange="setSTSValue(this)"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4 hidden">
                                ...
                                <div class="row bottom">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data45" class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data6" class="col-md-8">
                                            <select data-datafield="ADDRESS.STATE_CDE4" data-type="SheetDropDownList" id="ctl621351_control6" style="" data-displayemptyitem="true" data-onchange="set_Race_Province(this)"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data5" class="col-md-8">
                                            <select data-datafield="ADDRESS.CITY_CDE4" data-type="SheetDropDownList" id="ctl621351_control5" style="" data-displayemptyitem="true" data-onchange="set_Race_Province(this)"
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div id="ctl621351_Data14" class="col-md-8" style="width: 83%">
                                            <input type="text" data-datafield="ADDRESS.UNIT_NO" style="" data-type="SheetTextBox" id="ctl621351_control14" data-onchange="setRegisterAddress(this)">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="template">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data20" class="col-md-4 hidden">
        ...
        <div class="divContent" id="div_Detail_VEHICLE" style="padding-right: 0%">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="ctl524044_Data83" class="col-md-8">
                                            ...
                                            <div data-datafield="VEHICLE_DETAIL.GURANTEE_OPTION_H3" data-type="SheetCheckboxList" id="ctl844175" class="" style="" data-repeatdirection="Horizontal" data-repeatcolumns="2" data-masterdatacategory="担保方式" data-onchange="gurantee_option_chg()"></div>
                                        </div>
                                    </div>
                                </div>
                                <%--<div class="row hidden">
            ...
            <div class="row hidden" id="div_Cbankname">
        ...
        <div class="nav-icon fa  fa-chevron-down bannerTitle">
            <label id="Label2" data-en_us="Sheet information">审核信息</label>
        </div>
        <div class="divContent bottom" id="div2">
            <div class="row tableContent">
                ...
                <div id="control401" class="col-md-10">
                    <div data-datafield="zsshzt" data-type="SheetRadioButtonList" id="ctl271485" data-defaultselected="false" class="" style="" data-defaultitems="核准;拒绝;有条件核准;驳回;取消"></div>

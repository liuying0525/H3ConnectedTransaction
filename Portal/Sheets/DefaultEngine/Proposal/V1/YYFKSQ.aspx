...
<asp:Content ID="master" ContentPlaceHolderID="masterContent" runat="Server">
    ...
    <div class="panel-body sheetContainer" style="padding: 0;">
        ...
        <div class="divContent" id="divBaseInfo">
            ...
            <div>
                ...
                <div class="row">                    
                    ...
                    <div id="divdycsTitle" class="col-md-2">
                        <span id="Label448" data-type="SheetLabel" data-datafield="dycs" style="">抵押城市</span>
                    </div>
                    <div id="divdycs" class="col-md-4" style="color: red;">
        ...
        <div class="nav-icon fa  fa-chevron-down bannerTitle" id="divocrinfo" onclick="hidediv('divorc',this)">
            <label id="Label3" data-en_us="Sheet information">OCR智能识别</label>

        </div>
        <div class="divContent" id="divorc">
            <div class="divContent"><a href="#ocrDetail" data-toggle="modal" onclick="" target="_blank">报告详情>></a></div>
            <table class="SheetGridView" style="text-align: center; width: 100%;">
                <tbody id="ocr">
                </tbody>
            </table>
    ...
    <div id="ocrDetail" class="modal fade in" aria-hidden="true" style="width: 70%; margin: 0 auto; overflow-y: hidden">
        <div class="modal-header">
            <a class="close" data-dismiss="modal">×</a>
            <h3 style="text-align: center;">OCR智能识别-报告详情</h3>

        </div>
        <div class="modal-body" style="background-color: white">
            <div style="height: auto; min-height: 90px; overflow-y: auto;">
                <div class="row tableContent" style="border-right: 0px solid #ccc; border-top: 0px solid #ccc;">
                    <div id="control510" class="col-md-10" style="border-left: 0px solid #ccc; width: 99%">
                        <ul id="myTab" class="nav nav-tabs">
                            <li class="active"><a href="#bankcardandidcard" data-toggle="tab">银行卡、身份证</a></li>
                            <li><a href="#invoice" data-toggle="tab">发票</a></li>
                            <li><a href="#contract" data-toggle="tab">合同</a></li>
                            <li><a href="#deductionsAuthorized" data-toggle="tab">扣款授权书</a></li>
                            <li><a href="#policy" data-toggle="tab">保单</a></li>
                        </ul>
                        <div id="myTabContent" class="tab-content">
                            
                            <div class="tab-pane fade in active" id="bankcardandidcard">
                                <table class="SheetGridView" style="text-align: center; width: 100%;">
                                    <thead>
                                        <tr>
                                            <td class="col-md-2">类型</td>
                                            <td class="col-md-2">识别结果</td>
                                            <td class="col-md-2">系统数据</td>
                                            <td class="col-md-2">比对结果</td>
                                        </tr>
                                    </thead>
                                    <tbody id="idCardResultInfo">
                                    </tbody>
                                </table>
                            </div>
                            <div class="tab-pane" id="invoice">
                                <table class="SheetGridView" style="text-align: center; width: 100%;">
                                    ...
                                    <tbody id="vehicleInvoiceResultInfo">
                                    </tbody>
                                </table>
                            </div>
                            <div class="tab-pane" id="contract">
                                <table class="SheetGridView" style="text-align: center; width: 100%;">
                                    ...
                                    <tbody id="idContractResultInfo">
                                    </tbody>
                                </table>
                            </div>
                            <div class="tab-pane" id="deductionsAuthorized">
                                <table class="SheetGridView" style="text-align: center; width: 100%;">
                                    <thead>
                                        <tr>
                                            <td class="col-md-2">类型</td>
                                    ...
                                    <tbody id="idDeductionsAuthorizedInfo">
                                    </tbody>
                                </table>
                            </div>
    ...
    <script src="js/stringCompare.js?v=<%=DateTime.Now.ToString("yyyyMMdd") %>" type="text/javascript"></script>
    <script src="js/YYOcrResult.js?v=<%=DateTime.Now.ToString("yyyyMMdd") %>" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        $.MvcSheet.Loaded = function (sheetInfo) {
            ...
            //ocr智能识别
            setTimeout("ocr_intelligent_identification()", 1000);
        }
        function setValue() {
            //新车指导价
        ...
        $.MvcSheet.Validate = function () {
            ...
            if (this.IsReject && Activity == 'Activity17'&& this.Action =="Activity13") {
                    ...
                    if (result.Code == "1") {
                        if (result.Data && result.Data.length > 0) {
                            ...
                            result.Data.forEach(function (che300_data, che300_num) {
                                ...
                                var html_row = "<div class=\"row che300result\"><div class=\"col-md-2\"><label data-type=\"SheetLabel\">VIN码查询车型</label></div><div class=\"col-md-4\"><label><span>" + che300_model + "</span></label></div><div class=\"col-md-2\"><label data-type=\"SheetLabel\">VIN码查询价格</label></div><div class=\"col-md-4\"><label><span>" + che300_price + "</span></label></div></div>";
                                if (isok) {
                            ...
                            $("#powerPara").parent().after(html_val);
                            if (che300_data_num > 1) {
                                $(".che300result:eq(0) div:eq(0)").append("<i class=\"glyphicon glyphicon-chevron-right\" style=\"float:left;font-size:20px;\"></i>");
                        ...
                        $("#powerPara").parent().after(html_row);
                    }
                }
            });
        }

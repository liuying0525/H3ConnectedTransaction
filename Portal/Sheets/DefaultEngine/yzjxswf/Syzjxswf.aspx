<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Syzjxswf.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.Syzjxswf" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<div style="text-align: center;" class="DragContainer">
	<label id="lblTitle" class="panel-title">优质经销商维护</label>
</div>
		...
		<div class="divContent" id="divSheet">
			<div class="row">
				<div id="title1" class="col-md-2">
					<span id="Label11" data-type="SheetLabel" data-datafield="jxs" style="">经销商</span>
				</div>
				<div id="control1" class="col-md-4">
					<div id="Control11" data-datafield="jxs" data-type="SheetUser" style=""></div>
				</div>

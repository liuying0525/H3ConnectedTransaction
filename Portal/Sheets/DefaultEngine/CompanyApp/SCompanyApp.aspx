<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SCompanyApp.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.SCompanyApp" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<span class="OnlyDesigner">Originator.OUName</span>
        ...
        <div class="divContent" id="divSQR">
            ...
            <div id="divBascSQRInfo">
                <div class="row">
                    <div class="col-md-2">
                        <label data-type="SheetLabel" style="display: block;">风控模型评估</label>
                    </div>
                    <div class="col-md-2">
                        <label><a href="javascript:void(0);" onclick="rsfkClick()" target="_blank">评估结果</a></label>
                    </div>
                    <div class="col-md-2">
    ...
    <script type="text/javascript">
        ...
        function getCkje() {
            ...
            var currentV = $("#Control330").val();
            if (IdCardNo == "" || applicationno == "" || currentV == "") {
                return false;
            }
            $.ajax({
        ...
        function pbocClick(name, idtype, id) {
            ...
            var datajson = "{ \"reportRequest\": { \"repID\": \"" + InstanceId + "\", \"name\": \"" + name + "\", \"idtype\": \"" + idtype + "\", \"id\": \"" + id + "\", \"time\": \"\", \"operator\": \"\" } }";
            $.ajax({
                url: pbocurl,
                data: datajson,
                type: "POST",

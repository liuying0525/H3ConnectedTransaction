<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FISCFJ.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.FISCFJ" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<span class="OnlyDesigner">Originator.OUName</span>
        ...
        <div class="divContent" id="divattachment">
            ...
            <div class="row" style="display: none" id="TemplateDiv">
                ...
                <div id="control9" class="col-md-4">
                    <%-- <select data-datafield="Template" data-type="SheetDropDownList" id="ctl371782" class="" style="" data-schemacode="TemplateFile" data-querycode="GetTemplateName" data-filter="WorkflowType:InstanceType" data-datavaluefield="ObjectID" data-datatextfield="TemplateName" onchange="TemplateChange()">
                    </select>--%>
                     <select name="select2" id="select2" style="width: 250px" onchange="TemplateChange()">
            ...
            <div>
                <%--<div class="row">
                    <div id="title441" class="col-md-2">
                        <span id="Label395" data-type="SheetLabel" data-datafield="YHK" style="">面签照片</span>
                    </div>
                    <div id="control441" class="col-md-10">
                        <div id="Control395" data-datafield="YHK" data-type="SheetAttachment" style="" data-fileextensions=".jpg,.gif,.png,.bmp,.jpeg,.pdf"></div>
                    </div>
                </div>--%>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div id="control381" class="col-md-10">
                        <div id="Control352" data-datafield="BD" data-type="SheetAttachment" data-picturecompress="true" style="" data-fileextensions=".jpg,.gif,.png,.bmp,.jpeg,.pdf"></div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div id="control391" class="col-md-10">
                        <div id="Control357" data-datafield="YHKMFYJ" data-type="SheetAttachment" data-picturecompress="true" style="" data-fileextensions=".jpg,.gif,.png,.bmp,.jpeg,.pdf"></div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="nav-icon fa  fa-chevron-down bannerTitle" style="display:none" onclick="hidediv('div2',this)">
            <label id="Label2" data-en_us="Sheet information">审核信息</label>
        </div>
        <div class="divContent"  style="display:none" id="div2">
            <div class="row tableContent">
                <div id="title319" class="col-md-2">
                    <span id="Label286" data-type="SheetLabel" data-datafield="zsshzt">终审审核状态</span>
                </div>
                <div id="control401" class="col-md-10">
                    <div data-datafield="zsshzt" data-type="SheetRadioButtonList" id="ctl27148" class="" style="" data-defaultitems="核准;拒绝;有条件核准;取消"></div>
                </div>
            </div>
            <div class="row tableContent">

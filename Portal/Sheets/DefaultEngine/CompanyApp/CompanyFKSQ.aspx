<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyFKSQ.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.CompanyFKSQ" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
        ...
        <div class="divContent" id="divattachment">
            ...
            <div class="row" style="display: none" id="TemplateDiv">
                ...
                <div id="control9" class="col-md-4">
                    <%-- <select data-datafield="Template" data-type="SheetDropDownList" id="ctl371782" 
                        class=""  data-schemacode="TemplateFile" data-querycode="GetTemplateName"
                         data-filter="WorkflowType:InstanceType" data-datavaluefield="ObjectID" 
                        data-datatextfield="TemplateName" onchange="TemplateChange()" style="display:none">
                    </select>--%>
             ...
             <div class="row" id="HYXprint" style="display:none">
                <div id="contro8l11" class="col-md-4">
                    <input type="button" onclick="PrintHYX();" value="打印欢迎信" style="height: 30px; width: 80px" />
                </div>
            </div>
			...
			<div id="control437" class="col-md-10">
                ...
                <div class="row">
                    ...
                    <div id="control281" class="col-md-10">
                        <div id="Control262" data-datafield="HT" data-type="SheetAttachment" data-picturecompress="true" style="" data-fileextensions=".jpg,.gif,.png,.bmp,.jpeg,.pdf"></div>
                    </div>
                </div>
                <div class="row">
            ...
            <div>
				...
				<div id="control433" class="col-md-10">
					<div id="Control388" data-datafield="yyqtfj" data-type="SheetAttachment" data-picturecompress="true" style="">
    ...
    <script type="text/javascript">
      ...
      function yzlth(ts) {
        ...
        $.MvcSheet.Validate = function () {
            var Activity = '<%=this.ActionContext.ActivityCode%>';
            if (this.Action == "Submit" && Activity == 'Activity54') {
            ...
            if (!applicationNumber || applicationNumber.length <= 0 || !AccountName || AccountName.length <= 0 || !AccountNumber || AccountNumber.length <= 0 || !BankName || BankName.length <= 0 || !BranchName || BranchName.length <= 0 ||  !VinNo || VinNo.length <= 0) {
                alert("表单验证不通过！");
                return false;
            }

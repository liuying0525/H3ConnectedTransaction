...
<asp:Content ID="head" ContentPlaceHolderID="headContent" runat="Server">
    ...
    <script type="text/javascript" src="js/FIApplication.js?v=<%=DateTime.Now.ToString("yyyyMMdd") %>004"></script>
    ...
    <div class="panel-body sheetContainer">
        ...
        <div class="divContent" id="divSheet" style="padding-right: 0%">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div id="Div75" class="rightbox2">
                        <select id="Control58" data-datafield="APPLICATION_TYPE_CODE" data-type="SheetDropDownList" style="" data-queryable="false">
                            <option value="00001">个人Individual</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="row hidden">
                ...
                <div class="col-md-4">
                    <div id="title529" class="leftbox3">
                        <span id="Label469" data-type="SheetLabel" data-datafield="SaveDataFlag" style="">是否保存过</span>
                    </div>
                    <div class="centerline3"></div>
                    <div id="control521" class="rightbox3">
                        <input type="text" id="ctl291011" data-datafield="SaveDataFlag" data-type="SheetTextBox" style="" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div id="title539" class="leftbox3">
                        <span id="Label479" data-type="SheetLabel" style="">标志：是否要走信贷会节点</span>
                    </div>
                    <div class="centerline3"></div>
                    <div id="control531" class="rightbox3">
                        <input type="text" id="ctl291021" data-datafield="flag_NeedXDH" data-type="SheetTextBox" style="" />
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="divContent" id="divBorrower" style="padding-right: 0%">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" onclick="idcard_confirm_zy()">确认
                            </a>
                        </div>
                    </div>
                    <!-- /.modal-content -->
            ...
            <div class="row tableContent hidden">
                <div id="title75" class="col-md-2">
                    <span id="Label80" data-type="SheetLabel" data-datafield="APPLICANT_TYPE_ZY" style="">人员关系表</span>
                </div>
                <div id="Div97" class="col-md-10">
                    <table id="Control80" data-datafield="APPLICANT_TYPE_ZY" data-type="SheetGridView" class="SheetGridView" data-defaultrowcount="1">
                        <tbody>
                            <tr class="header">
                                <td id="Control80_SerialNo" class="rowSerialNo">序号								</td>
                                <td id="Control80_Header3" data-datafield="APPLICANT_TYPE_ZY.APPLICATION_NUMBER1">
                                    <label id="Control80_Label3" data-datafield="APPLICANT_TYPE_ZY.APPLICATION_NUMBER1" data-type="SheetLabel" style="">APPLICATION_NUMBER</label>
                                </td>
                                <td id="Control80_Header4" data-datafield="APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1">
                                    <label id="Control80_Label4" data-datafield="APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1" data-type="SheetLabel" style="">IDENTIFICATION_CODE</label>
                                </td>
                                <td id="Control80_Header5" data-datafield="APPLICANT_TYPE_ZY.APPLICANT_TYPE">
                                    <label id="Control80_Label5" data-datafield="APPLICANT_TYPE_ZY.APPLICANT_TYPE" data-type="SheetLabel" style="">APPLICANT_TYPE</label>
                                </td>
                                <td id="Control80_Header6" data-datafield="APPLICANT_TYPE_ZY.BUSINESS_PARTNER_ID">
                                    <label id="Control80_Label6" data-datafield="APPLICANT_TYPE_ZY.BUSINESS_PARTNER_ID" data-type="SheetLabel" style="">BUSINESS_PARTNER_ID</label>
                                </td>
                                <td id="Control80_Header7" data-datafield="APPLICANT_TYPE_ZY.GUARANTOR_TYPE">
                                    <label id="Control80_Label7" data-datafield="APPLICANT_TYPE_ZY.GUARANTOR_TYPE" data-type="SheetLabel" style="">GUARANTOR_TYPE</label>
                                </td>
                                <td id="Control80_Header8" data-datafield="APPLICANT_TYPE_ZY.MAIN_APPLICANT">
                                    <label id="Control80_Label8" data-datafield="APPLICANT_TYPE_ZY.MAIN_APPLICANT" data-type="SheetLabel" style="">MAIN_APPLICANT</label>
                                </td>
                                <td id="Control80_Header9" data-datafield="APPLICANT_TYPE_ZY.NAME1">
                                    <label id="Control80_Label9" data-datafield="APPLICANT_TYPE_ZY.NAME1" data-type="SheetLabel" style="">NAME</label>
                                </td>
                                <td id="Control80_Header10" data-datafield="APPLICANT_TYPE_ZY.IS_INACTIVE_IND">
                                    <label id="Control80_Label10" data-datafield="APPLICANT_TYPE_ZY.IS_INACTIVE_IND" data-type="SheetLabel" style="">IS_INACTIVE_IND</label>
                                </td>
                                <td class="rowOption">删除								</td>
                            </tr>
                            <tr class="template">
                                <td id="Control80_Option" class="rowOption"></td>
                                <td data-datafield="APPLICANT_TYPE_ZY.APPLICATION_NUMBER1">
                                    <input id="Control80_ctl3" type="text" data-datafield="APPLICANT_TYPE_ZY.APPLICATION_NUMBER1" data-type="SheetTextBox" style="">
                                </td>
                                <td data-datafield="APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1">
                                    <input id="Control80_ctl4" type="text" data-datafield="APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1" data-type="SheetTextBox" style="">
                                </td>
                                <td data-datafield="APPLICANT_TYPE_ZY.APPLICANT_TYPE">
                                    <input id="Control80_ctl5" type="text" data-datafield="APPLICANT_TYPE_ZY.APPLICANT_TYPE" data-type="SheetTextBox" style="">
                                </td>
                                <td data-datafield="APPLICANT_TYPE_ZY.BUSINESS_PARTNER_ID">
                                    <input id="Control80_ctl6" type="text" data-datafield="APPLICANT_TYPE_ZY.BUSINESS_PARTNER_ID" data-type="SheetTextBox" style="">
                                </td>
                                <td data-datafield="APPLICANT_TYPE_ZY.GUARANTOR_TYPE">
                                    <input id="Control80_ctl7" type="text" data-datafield="APPLICANT_TYPE_ZY.GUARANTOR_TYPE" data-type="SheetTextBox" style="">
                                </td>
                                <td data-datafield="APPLICANT_TYPE_ZY.MAIN_APPLICANT">
                                    <input id="Control80_ctl8" type="text" data-datafield="APPLICANT_TYPE_ZY.MAIN_APPLICANT" data-type="SheetTextBox" style="">
                                </td>
                                <td data-datafield="APPLICANT_TYPE_ZY.NAME1">
                                    <input type="text" id="Control80_ctl9" data-datafield="APPLICANT_TYPE_ZY.NAME1" data-type="SheetTextBox" style="" />
                                </td>
                                <td data-datafield="APPLICANT_TYPE_ZY.IS_INACTIVE_IND">
                                    <input id="Control80_ctl10" type="text" data-datafield="APPLICANT_TYPE_ZY.IS_INACTIVE_IND" data-type="SheetTextBox" style="">
                                </td>
                                <td class="rowOption">
                                    <a class="delete">
        ...
        <div class="divContent" id="div_Detail_Individual" style="padding-right: 0%">
            <div class="row tableContent" id="detail_Individual">
                <div id="div695471" class="col-md-12">
                    <div id="ctl604410" data-datafield="APPLICANT_DETAIL_ZY" data-type="SheetDetail" class="" style="" data-filter="{IDENTIFICATION_CODE2}:{IDENTIFICATION_ID}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data49" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.FIRST_THI_NME" style="" data-type="SheetTextBox" id="ctl604410_control49"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data43" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.ID_CARD_TYP" data-type="SheetDropDownList" id="ctl604410_control43" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data44" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.ID_CARD_NBR" data-type="SheetTextBox" id="ctl604410_control44" style="" data-onchange="IdentifyCodeChange(this)" maxlength="18">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data15" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.DATE_OF_BIRTH" data-type="SheetTime" id="ctl604410_control15" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data24" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.SEX" data-type="SheetDropDownList" id="ctl604410_control24" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data62" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.HUKOU_CDE" data-type="SheetDropDownList" id="ctl604410_control62" style=""
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data78" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.NATION_CDE" data-type="SheetDropDownList" id="ctl604410_control78" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data79" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.ISSUING_AUTHORITY" style="" data-type="SheetTextBox" id="ctl604410_control79" onkeyup="this.value=strMaxLength(this.value,'500')" maxlength="250">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data53" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.EDUCATION_CDE" data-type="SheetDropDownList" id="ctl604410_control53" style=""
                                ...
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data52" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.GUARANTOR_RELATIONSHIP_CDE" data-type="SheetDropDownList" id="ctl604410_control52" style="" data-displayemptyitem="true"
                                    ...
                                    <div class="col-md-4 hidden">
                                        <div id="ctl604410_Data76" class="col-md-4">
                                            <input type="checkbox" data-datafield="APPLICANT_DETAIL_ZY.SPOUSE_IND" data-type="SheetCheckbox" id="ctl604410_control76" style="" data-text="Spouse" data-onchange="spouse_chg(this)">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data7" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.EMPLOYMENT_TYPE_CDE" data-type="SheetDropDownList" id="ctl604410_control7" >
                                                <option></option>
                                                <option value="0">企业股东</option>
                                                <option value="1">受薪人士</option>
                                                <option value="2">自雇人士</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data4" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.INDUSTRY_TYPE_CDE" data-type="SheetDropDownList" id="ctl604410_control4" style="" data-displayemptyitem="true"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data6" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.INDUSTRY_SUBTYPE_CDE" data-type="SheetDropDownList" id="ctl604410_control6" style="" data-displayemptyitem="true"
                                                data-schemacode="M_industry_sub_type_cde" data-querycode="010" data-filter="APPLICANT_DETAIL_ZY.INDUSTRY_TYPE_CDE:industry_type_cde" data-datavaluefield="INDUSTRY_SUBTYPE_CDE" data-datatextfield="INDUSTRY_SUBTYPE_DSC">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data10" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.OCCUPATION_CDE" data-type="SheetDropDownList" id="ctl604410_control10" style="" data-displayemptyitem="true"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data69" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.SUB_OCCUPATION_CDE" data-type="SheetDropDownList" id="ctl604410_control69" style="" data-queryable="false"
                                                data-schemacode="M_sub_occupation" data-querycode="012" data-filter="APPLICANT_DETAIL_ZY.OCCUPATION_CDE:OCCUPATION_CDE" data-datavaluefield="SUB_OCCUPATION_CDE" data-datatextfield="SUB_OCCUPATION_DSC">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data70" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.DESIGNATION_CDE" data-type="SheetDropDownList" id="ctl604410_control70" style="" >
                                                <option><option>
                                                <option value="1">厅局级及以上</option>
                                                <option value="2">处级</option>
                                                <option value="3">科级</option>
                                                <option value="4">一般干部</option>
                                                <option value="5">其他</option>
                                                <option value="6">总经理级</option>
                                                <option value="7">部门经理级</option>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data73" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.ACTUAL_SALARY" data-type="SheetTextBox" id="ctl604410_control73" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data9" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.MARITAL_STATUS_CDE" data-type="SheetDropDownList" id="ctl604410_control9" style="" data-onchange="marital_chg(this)">
                                                <option></option>
                                                <option value="0">未婚</option>
                                                <option value="1">已婚无子女</option>
                                                <option value="2">已婚有子女</option>
                                                <option value="3">其他（离婚、丧偶、再婚）</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data3" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.RACE_CDE" data-type="SheetDropDownList" id="ctl604410_control3" style=""
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data13" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.LAST_NAME" data-type="SheetTextBox" id="ctl604410_control13" style="" onkeyup="this.value=strMaxLength(this.value,'30')" maxlength="30">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data11" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.FIRST_NAME" style="" data-type="SheetTextBox" id="ctl604410_control11">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data12" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.MIDDLE_NAME" style="" data-type="SheetTextBox" id="ctl604410_control12">
                                        </div>
                                    </div>
                                </div>
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data14" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.LICENSE_NUMBER" data-type="SheetTextBox" id="ctl604410_control14" style="" 
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data16" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.LICENSE_EXPIRY_DATE" data-type="SheetTime" id="ctl604410_control16" style=""
                                                data-defaultvalue="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data77" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.FORMER_NAME" style="" data-type="SheetTextBox" id="ctl604410_control77">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data45" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.ID_CARDISSUE_DTE" data-type="SheetTime" id="ctl604410_control45" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data46" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.ID_CARDEXPIRY_DTE" data-type="SheetTime" id="ctl604410_control46" style="" data-defaultvalue=""
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data18" class="col-md-4">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.AGE_IN_YEAR" data-type="SheetTextBox" id="ctl604410_control18" readonly style="width: 50%" >年
                                        </div>
                                        <div id="ctl604410_Data19" class="col-md-4">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.AGE_IN_MONTH" data-type="SheetTextBox" id="ctl604410_control19" readonly style="width: 50%" >月
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div id="ctl604410_Data74" >
                                            <input type="checkbox" data-datafield="APPLICANT_DETAIL_ZY.LIENEE" data-type="SheetCheckbox" id="ctl604410_control74" style="" data-text="抵押人"
                                    ...
                                    <%--<div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data68" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.HOUSE_OWNER_CDE" data-type="SheetDropDownList" id="ctl604410_control68" style="" data-queryable="false" data-displayemptyitem="true"
                                ...
                                <div class="row bottom">
                                    <div class="col-md-4 hidden">
                                        ...
                                        <div id="ctl604410_Data75" class="col-md-8">
                                            <select data-datafield="APPLICANT_DETAIL_ZY.DRIVING_LICENSE_CODE" data-type="SheetDropDownList" id="ctl604410_control75" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data25" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.EMAIL_ADDRESS" data-type="SheetTextBox" id="ctl604410_control25" style="" onkeyup="this.value=strMaxLength(this.value,'50')" maxlength="25" 
                                ...
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data37" class="col-md-8">
                                            <input type="checkbox" data-datafield="APPLICANT_DETAIL_ZY.CHILDREN_FLAG" data-type="SheetCheckbox" id="ctl604410_control37" style="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data63" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.NO_OF_FAMILY_MEMBERS" data-type="SheetTextBox" id="ctl604410_control63" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data17" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.NUMBER_OF_DEPENDENT" data-type="SheetTextBox" id="ctl604410_control17" style=""
                                                data-regularexpression="/^[+]{0,1}(\d+)$/" data-regularinvalidtext="请输入正整数" maxlength="2">
                                        </div>
                                    </div>
                                </div>
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl604410_Data1" class="col-md-8">
                                            <input type="text" data-datafield="APPLICANT_DETAIL_ZY.IDENTIFICATION_CODE2" data-type="SheetTextBox" id="ctl604410_control1" style="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
										...
										<div id="ctl604410_Data8" class="col-md-8">
											<input type="text" data-datafield="APPLICANT_DETAIL_ZY.TITLE_CDE" data-type="SheetTextBox" id="ctl604410_control8" style=""
                                    ...
                                    <div class="col-md-4">
										...
										<div id="ctl604410_Data57" class="col-md-8">
											<input type="text" data-datafield="APPLICANT_DETAIL_ZY.THAI_TITLE_CDE" data-type="SheetTextBox" id="ctl604410_control57" style=""
                                                data-defaultvalue="00001">
 										</div>
									</div>
                                </div>
                                <div class="row bottom hidden">
                                    <div class="col-md-12" style="padding-bottom: 0px!important; margin-bottom: 0px!important; border-bottom: 1px solid #ccc!important;">
                                        <%--<div id="ctl604410_Data20" class="col-md-2">
                                            <input type="checkbox" data-datafield="APPLICANT_DETAIL_ZY.PRIVACY_ACT" data-type="SheetCheckbox" id="ctl604410_control20" style="" data-text="同意">
                                        </div>
                                        <div id="ctl604410_Data67" class="col-md-2">
                                            <input type="checkbox" data-datafield="APPLICANT_DETAIL_ZY.VIP_IND" data-type="SheetCheckbox" id="ctl604410_control67" style="" data-text="贵宾">
                                        </div>
                                        <div id="ctl604410_Data66" class="col-md-2">
                                            <input type="checkbox" data-datafield="APPLICANT_DETAIL_ZY.STAFF_IND" data-type="SheetCheckbox" id="ctl604410_control66" style="" data-text="工作人员">
                                        </div>
                                        <div id="ctl604410_Data55" class="col-md-2">
                                            <input type="checkbox" data-datafield="APPLICANT_DETAIL_ZY.BLACKLIST_NORECORD_IND" data-type="SheetCheckbox" id="ctl604410_control55" style="" data-text="黑名单中无记录"
                                                disabled data-defaultvalue="true">
                                        </div>
                                        <div id="ctl604410_Data48" class="col-md-2">
                                            <input type="checkbox" data-datafield="APPLICANT_DETAIL_ZY.BLACKLIST_IND" data-type="SheetCheckbox" id="ctl604410_control48" style="" data-text="外部信用记录"
                                                disabled>
                                        </div>--%>
        ...
        <%-- 机构贷申请详细表 --%>
        <div class="nav-icon fa  fa-chevron-right bannerTitle hidden" id="detail_Company_Title" onclick="hidediv('div_Detail_Company',this)">
            <span>公司信息</span>
        </div>
        <div class="divContent" id="div_Detail_Company" style="padding-right: 0%">
            <div class="row tableContent" id="detail_Company">
                <div id="div322965" class="col-md-12">
                    <div id="ctl863190" data-datafield="COMPANY_DETAIL_ZY" data-type="SheetDetail" class="" style="" data-filter="{IDENTIFICATION_CODE3}:{IDENTIFICATION_ID}"
                        data-defaultrowcount="0" data-displayadd="false">
                                ...
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data1" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.IDENTIFICATION_CODE3" data-type="SheetTextBox" id="ctl863190_control1" style="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data34" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.ORGANIZATION_CDE" data-type="SheetTextBox" id="ctl863190_control34" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data25" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.COMPANY_STS" data-type="SheetTextBox" id="ctl863190_control25" style=""
                                                 maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data26" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.COMPANY_THI_NME" style="" data-type="SheetTextBox" id="ctl863190_control26"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data2" class="col-md-8">
                                            <select data-datafield="COMPANY_DETAIL_ZY.BUSINESS_TYPE_CDE" data-type="SheetDropDownList" id="ctl863190_control2" style="" data-displayemptyitem="true" data-queryable="false"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data37" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.CAPITAL_REGISTRATION_AMT" data-type="SheetTextBox" id="ctl863190_control37" style="" maxlength="12">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data31" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.ESTABLISHED_SINCE" data-type="SheetTime" id="ctl863190_control31" style="" data-defaultvalue=""
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data11" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.PARENT_COMPANY" style="" data-type="SheetTextBox" id="ctl863190_control11" onkeyup="this.value=strMaxLength(this.value,'100')" maxlength="50">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data12" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.SUBSIDIARY_COMPANY" style="" data-type="SheetTextBox" id="ctl863190_control12" onkeyup="this.value=strMaxLength(this.value,'100')" maxlength="50">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data3" class="col-md-8">
                                            <select data-datafield="COMPANY_DETAIL_ZY.INDUSTRY_TYPE_CDE" data-type="SheetDropDownList" id="ctl863190_control3" style="" data-displayemptyitem="true"
                                                data-schemacode="M_industry_type_code" data-querycode="009" data-datavaluefield="INDUSTRY_TYPE_CDE" data-datatextfield="INDUSTRY_TYPE_DSC">
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data4" class="col-md-8">
                                            <select data-datafield="COMPANY_DETAIL_ZY.INDUSTRY_SUBTYPE_CDE" data-type="SheetDropDownList" id="ctl863190_control4" style=""
                                                data-schemacode="M_industry_sub_type_cde" data-querycode="010" data-filter="COMPANY_DETAIL_ZY.INDUSTRY_TYPE_CDE:industry_type_cde" data-datavaluefield="INDUSTRY_SUBTYPE_CDE" data-datatextfield="INDUSTRY_SUBTYPE_DSC">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data39" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.REP_NAME" style="" data-type="SheetTextBox" id="ctl863190_control39" onkeyup="this.value=strMaxLength(this.value,'100')" maxlength="50">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data42" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.REP_ID_CARD_NO" data-type="SheetTextBox" id="ctl863190_control42" style=""
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data44" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.REPRESENTATIVE_DESIGNATION" style="" data-type="SheetTextBox" id="ctl863190_control44">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data40" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.LENDING_CODE" data-type="SheetTextBox" id="ctl863190_control40" style="" data-onchange="lending_chg(this)" maxlength="18" onkeyup="this.value=strMaxLength(this.value,'18')">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data43" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.LOAN_CRD_PWD" data-type="SheetTextBox" id="ctl863190_control43" style="" maxlength="6" onkeyup="value=value.replace(/[^\d]/g,'')">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data5" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.NAME3" style="" data-type="SheetTextBox" id="ctl863190_control5">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data14" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.BUSINESS_HISTORY" style="" data-type="SheetTextBox" id="ctl863190_control14"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data41" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.EMPLOYEE_NUMBER" data-type="SheetTextBox" id="ctl863190_control41" style="" onkeyup="this.value=strMaxLength(this.value,'50')" maxlength="50">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data15" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.FUTURE_DIRECTION" style="" data-type="SheetTextBox" id="ctl863190_control15"
                                                onkeyup="this.value=strMaxLength(this.value,'100')" maxlength="50">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data13" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.FLEET_SIZE" data-type="SheetTextBox" id="ctl863190_control13" style="" maxlength="9">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data36" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.NET_WORTH_AMT" data-type="SheetTextBox" id="ctl863190_control36" style="" maxlength="9">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data17" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.EMAIL_ADDRESS" data-type="SheetTextBox" id="ctl863190_control17" style="" onkeyup="this.value=strMaxLength(this.value,'50')" maxlength="25"
                                                data-regularexpression="/^([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{2,3}$/" data-regularinvalidtext="请输入有效的邮箱地址">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl863190_Data32" class="col-md-8">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.ESTABLISHED_SINCE_YY" disabled data-type="SheetTextBox" id="ctl863190_control32" style=""
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="ctl863190_Data30" class="col-md-2">
                                            <input type="checkbox" data-datafield="COMPANY_DETAIL_ZY.BLACKLIST_NORECORD_IND" data-type="SheetCheckbox" id="ctl863190_control30" style="" disabled data-defaultvalue="true" data-text="黑名单中无记录">
                                        </div>
                                        <div id="ctl863190_Data28" class="col-md-2">
                                            <input type="checkbox" data-datafield="COMPANY_DETAIL_ZY.BLACKLIST_IND" data-type="SheetCheckbox" id="ctl863190_control28" style="" disabled data-text="外部信用記錄">
                                        </div>
                                        <div id="ctl863190_Data45" class="col-md-2">
                                            <input type="checkbox" data-datafield="COMPANY_DETAIL_ZY.LIENEE" data-type="SheetCheckbox" id="ctl863190_control45" style="" data-text="抵押人"
                                                data-onchange="ck_Lienee_change(this)">
                                        </div>
                                ...
                                <div class="row bottom">
                                    <div class="col-md-12">
                                        ...
                                        <div id="ctl863190_Data16" class="col-md-10" style="width: 88%">
                                            <input type="text" data-datafield="COMPANY_DETAIL_ZY.COMPANY_DETAIL_COMMENT" style="" data-type="SheetTextBox" id="ctl863190_control16" 
                                                onkeyup="this.value=strMaxLength(this.value,'100')" maxlength="50"/>
                                        </div>
                                    </div>
                                </div>
        ...
        <%-- 配偶信息 --%>
        <div class="nav-icon fa  fa-chevron-down bannerTitle" id="detail_Spouse_Title" onclick="hidediv('divSpouse',this)">
            <span>配偶信息</span>
        </div>
        <div class="divContent" id="divSpouse" style="padding-right: 0%;">
            <div class="row hidden">
                <div class="col-md-4">
                    <div class="col-md-4">
                        <span data-type="SheetLabel" data-datafield="MARITAL_STATUS_CDE" style="">主贷人婚姻状况</span>
                    </div>
                    <div class="col-md-8">
                        <input id="Control1262" type="text" data-datafield="MARITAL_STATUS_CDE" data-type="SheetTextBox" style="">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div id="title167" class="col-md-4">
                        <span id="Label126" data-type="SheetLabel" data-datafield="MATE_NAME" style="">配偶姓名</span>
                    </div>
                    <div id="control167" class="col-md-8">
                        <input id="Control126" type="text" data-datafield="MATE_NAME" data-type="SheetTextBox" style="" data-vaildationrule="{MARITAL_STATUS_CDE}=='1'||{MARITAL_STATUS_CDE}=='2'">
                    </div>
                </div>
                <div class="col-md-4">
                    <div id="title169" class="col-md-4">
                        <span id="Label128" data-type="SheetLabel" data-datafield="MATE_MOBILE" style="">配偶手机号</span>
                    </div>
                    <div id="control169" class="col-md-8">
                        <input id="Control128" type="text" data-datafield="MATE_MOBILE" data-type="SheetTextBox" style="" data-vaildationrule="{MARITAL_STATUS_CDE}=='1'||{MARITAL_STATUS_CDE}=='2'"
                            data-regularexpression="/^[1][3,4,5,6,7,8,9][0-9]{9}$/" maxlength="11" data-regularinvalidtext="请输入有效的手机号码">
                    </div>
                </div>
                <div class="col-md-4">
                    <div id="title168" class="col-md-4">
                        <span id="Label127" data-type="SheetLabel" style="">关系</span>
                    </div>
                    <div id="control168" class="col-md-8">
                        <%--<input id="Control127" type="text" data-datafield="MATE_RELATIONSHIP_CDE"  data-type="SheetTextBox" style="" data-vaildationrule="{MARITAL_STATUS_CDE}=='A'||{MARITAL_STATUS_CDE}=='B'">--%>
                        <select data-datafield="MATE_RELATIONSHIP_CDE"  id="Control127" style="" data-type="SheetDropDownList" data-vaildationrule="{MARITAL_STATUS_CDE}=='1'||{MARITAL_STATUS_CDE}=='2'" >
                            <option></option>
        ...
        <div class="divContent" id="div_Contact_WorkInfo" style="padding-right: 0%; display: none">
            <div class="row tableContent">
                <div id="div474160" class="col-md-12">
                    <div id="ctl474160" data-datafield="PERSONNAL_REFERENCE_ZY" data-type="SheetDetail" class="SheetGridView" style="" data-filter="{IDENTIFICATION_CODE10}:{IDENTIFICATION_ID}" 
                                ...
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl474160_Data0" class="col-md-8">
                                            <input type="text" data-datafield="PERSONNAL_REFERENCE_ZY.IDENTIFICATION_CODE10" data-type="SheetTextBox" id="ctl474160_control0" style="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl474160_Data3" class="col-md-8">
                                            <input type="text" data-datafield="PERSONNAL_REFERENCE_ZY.LINE_ID10" data-type="SheetTextBox" id="ctl474160_control3" style="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row bottom">
                                    <div class="col-md-4">
                                        <div id="ctl474160_Title5" class="col-md-4">
                                            <span id="ctl474160_label5">姓名</span>
                                        </div>
                                        <div id="ctl474160_Data5" class="col-md-8">
                                            <input type="text" data-datafield="PERSONNAL_REFERENCE_ZY.NAME10" data-type="SheetTextBox" id="ctl474160_control5" style="" onkeyup="this.value=strMaxLength(this.value,'30')" maxlength="15" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl474160_Data24" class="col-md-8">
                                            <input type="text" data-datafield="PERSONNAL_REFERENCE_ZY.MOBILE" data-type="SheetTextBox" id="ctl474160_control24" style="" data-regularexpression="/^[1][3,4,5,6,7,8,9][0-9]{9}$/" maxlength="11" data-regularinvalidtext="请输入有效的手机号码" >
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl474160_Data23" class="col-md-8">
                                            <select data-datafield="PERSONNAL_REFERENCE_ZY.RELATIONSHIP_CDE" data-type="SheetDropDownList" id="ctl474160_control23" style=""  >
                                                <option></option>
                                ...
                                <div class="row hidden">
                                    <div class="col-md-8">
                                        ...
                                        <div id="ctl474160_Data9" class="col-md-8" style="width: 83%">
                                            <input type="text" data-datafield="PERSONNAL_REFERENCE_ZY.ADDRESS_ONE" data-type="SheetTextBox" id="ctl474160_control9" style="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl474160_Data15" class="col-md-8">
                                            <input type="text" data-datafield="PERSONNAL_REFERENCE_ZY.PHONE" data-type="SheetTextBox" id="ctl474160_control15" style="" data-regularexpression="/^[1][3,4,5,6,7,8,9][0-9]{9}$/" onkeyup="this.value=strMaxLength(this.value,'15')" maxlength="11">
                                        </div>
                                    </div>
                                </div>
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl474160_Data28" class="col-md-8">
                                            <select data-datafield="PERSONNAL_REFERENCE_ZY.HOKOU_TYPE" data-type="SheetDropDownList" id="ctl474160_control28" style=""
                                                data-masterdatacategory="户口所在地" data-queryable="false" data-displayemptyitem="true">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl474160_Data7" class="col-md-8">
                                            <select data-datafield="PERSONNAL_REFERENCE_ZY.STATE_CDE10" data-type="SheetDropDownList" id="ctl474160_control7" style="" data-displayemptyitem="true"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl474160_Data2" class="col-md-8">
                                            <select data-datafield="PERSONNAL_REFERENCE_ZY.CITY_CDE10" data-type="SheetDropDownList" id="ctl474160_control2" style="" data-displayemptyitem="true"
                                                data-schemacode="M_city_all" data-querycode="fun_M_city_all" data-filter="PERSONNAL_REFERENCE_ZY.STATE_CDE10:state_cde" data-datavaluefield="CITY_CDE" data-datatextfield="CITY_NME">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row hidden bottom">
                                    <div class="col-md-4">
                                        <div id="ctl474160_Title14" class="col-md-4">
                                            <span id="ctl474160_label14">邮编</span>
                                        </div>
                                        <div id="ctl474160_Data14" class="col-md-8">
                                            <input type="text" data-datafield="PERSONNAL_REFERENCE_ZY.POST_CODE" data-type="SheetTextBox" id="ctl474160_control14" style="" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="6" data-onchange="postcode_chg(this)">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="divContent" id="div_Detail_Address" style="padding-right: 0%">
            <div class="row tableContent">
                <div id="div169380" class="col-md-12">
                    <div id="ctl621351" data-datafield="ADDRESS_ZY" data-type="SheetDetail" class="" style="" data-filter="{IDENTIFICATION_CODE4}:{IDENTIFICATION_ID}"
                            ...
                            <div class="template">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div id="ctl621351_Title6" class="col-md-4">
                                            <span id="ctl621351_label6" style="">户籍省份</span>
                                        </div>
                                        <div id="ctl621351_Data6" class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.STATE_CDE4" data-type="SheetDropDownList" id="ctl621351_control6" style="" data-displayemptyitem="true" 
                                                data-schemacode="area" data-querycode="area_all" data-filter="100000:PARENTID" data-datavaluefield="CODEID" data-datatextfield="CODENAME">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div id="ctl621351_Title5" class="col-md-4">
                                            <span id="ctl621351_label5" style="">户籍城市</span>
                                        </div>
                                        <div id="ctl621351_Data5" class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.CITY_CDE4" data-type="SheetDropDownList" id="ctl621351_control5" style="" data-displayemptyitem="true" 
                                                data-schemacode="area" data-querycode="area_all" data-filter="ADDRESS_ZY.STATE_CDE4:PARENTID" data-datavaluefield="CODEID" data-datatextfield="CODENAME">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div id="ctl621351_Title7" class="col-md-4">
                                            <span id="ctl621351_label7" style="">户籍区县</span>
                                        </div>
                                        <div id="ctl621351_Data7" class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.AREA4" data-type="SheetDropDownList" id="ctl621351_control7" style="" data-displayemptyitem="true" 
                                                data-schemacode="area" data-querycode="area_all" data-filter="ADDRESS_ZY.CITY_CDE4:PARENTID" data-datavaluefield="CODEID" data-datatextfield="CODENAME">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data9" class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.ADDRESS_TYPE_CDE" data-type="SheetDropDownList" id="ctl621351_control9" style="" data-displayemptyitem="true"
                                     ...
                                     <div class="col-md-8">
                                        <div id="ctl621352_Title38" class="col-md-4">
                                            <span id="ctl621352_label38" style="">户籍地址</span>
                                        </div>
                                        <div id="ctl621352_Data38" class="col-md-8">
                                            <input type="text" data-datafield="ADDRESS_ZY.ADDRESS_ID" style="" data-type="SheetTextBox" id="ctl621352_control38" onkeyup="this.value=strMaxLength(this.value,'500')" maxlength="200">
                                            <%--<label class="requiredflag">*</label>--%>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.CurrentState" data-type="SheetDropDownList" id="ctl_CurrentState" style="" data-displayemptyitem="true" 
                                                data-schemacode="area" data-querycode="area_all" data-filter="100000:PARENTID" data-datavaluefield="CODEID" data-datatextfield="CODENAME">
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.CurrentCity" data-type="SheetDropDownList" id="ctl_CurrentCity" style="" data-displayemptyitem="true" data-onchange=""
                                                data-schemacode="area" data-querycode="area_all" data-filter="ADDRESS_ZY.CurrentState:PARENTID" data-datavaluefield="CODEID" data-datatextfield="CODENAME">
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="col-md-4">
                                            <span style="">现居住地区县</span>
                                        </div>
                                        <div class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.CurrentArea" data-type="SheetDropDownList" id="ctl_Current" style="" data-displayemptyitem="true" data-onchange=""
                                                data-schemacode="area" data-querycode="area_all" data-filter="ADDRESS_ZY.CurrentCity:PARENTID" data-datavaluefield="CODEID" data-datatextfield="CODENAME">
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data39" class="col-md-8">
                                            <input type="text" data-datafield="ADDRESS_ZY.NATIVE_DISTRICT" style="" data-type="SheetTextBox" id="ctl621351_control39" onkeyup="this.value=strMaxLength(this.value,'500')" maxlength="200">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data40" class="col-md-8">
                                            <input type="text" data-datafield="ADDRESS_ZY.BIRTHPLEASE_PROVINCE" style="" data-type="SheetTextBox" id="ctl621351_control40" onkeyup="this.value=strMaxLength(this.value,'500')" maxlength="200">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div id="ctl621351_Title14" class="col-md-4" style="">
                                            <span id="ctl621351_label14" style="">地址</span>
                                        </div>
                                        <div id="ctl621351_Data14" class="col-md-8" style="">
                                            <input type="text" data-datafield="ADDRESS_ZY.UNIT_NO" style="" data-type="SheetTextBox" id="ctl621351_control14">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data11" class="col-md-8">
                                            <input type="text" data-datafield="ADDRESS_ZY.POST_CODE_2" style="" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="6" data-type="SheetTextBox" id="ctl621351_control11" data-onchange="postcode_chg(this)">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="col-md-4">
                                            <span style="">本人名下是否有房产</span>
                                        </div>
                                        <div class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.HaveHouse" data-type="SheetDropDownList" id="haveHouse" style="">
                                ...
                                <div class="row bottom">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data3" class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.PROPERTY_TYPE_CDE" data-type="SheetDropDownList" id="ctl621351_control3" style="" >
                                                <option></option>
                                                <option value="1">商业按揭购房</option>
                                                <option value="2">无按揭购房</option>
                                                <option value="3">公积金按揭购房</option>
                                                <option value="4">自建房</option>
                                                <option value="5">租用</option>
                                                <option value="6">暂住</option>
                                                <option value="7">亲属住房</option>
                                                <option value="8">单位住房</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data4" class="col-md-8">
                                            <select data-datafield="ADDRESS_ZY.RESIDENCE_TYPE_CDE" data-type="SheetDropDownList" id="ctl621351_control4" style="" data-displayemptyitem="true"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data33" class="col-md-8">
                                            <input type="text" data-datafield="ADDRESS_ZY.LIVING_FROM_DTE" data-type="SheetTime" id="ctl621351_control33" style=""
                                ...
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data2" class="col-md-8">
                                            <input type="text" data-datafield="ADDRESS_ZY.IDENTIFICATION_CODE4" data-type="SheetTextBox" id="ctl621351_control2" style="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl621351_Data1" class="col-md-8">
                                            <input type="text" data-datafield="ADDRESS_ZY.ADDRESS_CODE" data-type="SheetTextBox" id="ctl621351_control1" style="">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row tableContent">
                <div id="div924412" class="col-md-12">
                    ...
                    <table id="ctl629122" data-datafield="APPLICANT_PHONE_FAX_ZY" data-type="SheetGridView" class="SheetGridView" style=""
                        data-defaultrowcount="0" data-displayadd="false">
                        <tbody>
                            <tr class="header">
                                <td id="ctl629122_SerialNo" class="rowSerialNo">序号</td>
                                <td id="ctl629122_header0" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_SEQ_ID" style="" class="hidden">
                                    <label id="ctl629122_Label0" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_SEQ_ID" data-type="SheetLabel" style="">PHONE_SEQ_ID</label></td>
                                <%--<td id="ctl629122_header1" data-datafield="APPLICANT_PHONE_FAX_ZY.APPLICATION_NUMBER5" style="">
                                    <label id="ctl629122_Label1" data-datafield="APPLICANT_PHONE_FAX_ZY.APPLICATION_NUMBER5" data-type="SheetLabel" style="">APPLICATION_NUMBER</label></td>--%>
                                <td id="ctl629122_header2" data-datafield="APPLICANT_PHONE_FAX_ZY.IDENTIFICATION_CODE5" style="" class="hidden">
                                    <label id="ctl629122_Label2" data-datafield="APPLICANT_PHONE_FAX_ZY.IDENTIFICATION_CODE5" data-type="SheetLabel" style="">IDENTIFICATION_CODE</label></td>
                                <td id="ctl629122_header3" data-datafield="APPLICANT_PHONE_FAX_ZY.COUNTRY_CODE" style="width: 100px">
                                    <label id="ctl629122_Label3" data-datafield="APPLICANT_PHONE_FAX_ZY.COUNTRY_CODE" data-type="SheetLabel" style="">国家代码</label></td>
                                <td id="ctl629122_header5" data-datafield="APPLICANT_PHONE_FAX_ZY.AREA_CODE" style="">
                                    <label id="ctl629122_Label5" data-datafield="APPLICANT_PHONE_FAX_ZY.AREA_CODE" data-type="SheetLabel" style="">地区代码</label></td>
                                <td id="ctl629122_header20" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_NUMBER" style="">
                                    <label id="ctl629122_Label20" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_NUMBER" data-type="SheetLabel" style="">电话</label></td>
                                <td id="ctl629122_header19" data-datafield="APPLICANT_PHONE_FAX_ZY.EXTENTION_NBR" style="">
                                    <label id="ctl629122_Label19" data-datafield="APPLICANT_PHONE_FAX_ZY.EXTENTION_NBR" data-type="SheetLabel" style="">分机</label></td>
                                <td id="ctl629122_header4" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_TYPE_CDE" style="">
                                    <label id="ctl629122_Label4" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_TYPE_CDE" data-type="SheetLabel" style="">电话类型</label></td>

                                <td id="ctl629122_header18" data-datafield="APPLICANT_PHONE_FAX_ZY.ADDRESS_CODE5" style="" class="hidden">
                                    <label id="ctl629122_Label18" data-datafield="APPLICANT_PHONE_FAX_ZY.ADDRESS_CODE5" data-type="SheetLabel" style="">ADDRESS_CODE</label></td>

                                <td class="rowOption">删除</td>
                            </tr>
                            <tr class="template">
                                <td style="text-align: center"></td>
                                <td id="ctl629122_control10" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_SEQ_ID" style="" class="hidden">
                                    <input type="text" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_SEQ_ID" data-type="SheetTextBox" id="ctl629122_control0" style=""></td>
                                <%--<td id="ctl629122_control1" data-datafield="APPLICANT_PHONE_FAX_ZY.APPLICATION_NUMBER5" style="">
                                    <input type="text" data-datafield="APPLICANT_PHONE_FAX_ZY.APPLICATION_NUMBER5" data-type="SheetTextBox" id="ctl629122_control1" style=""></td>--%>
                                <td id="ctl629122_control12" data-datafield="APPLICANT_PHONE_FAX_ZY.IDENTIFICATION_CODE5" style="" class="hidden">
                                    <input type="text" data-datafield="APPLICANT_PHONE_FAX_ZY.IDENTIFICATION_CODE5" data-type="SheetTextBox" id="ctl629122_control2" style=""></td>
                                <td id="ctl629122_control13" data-datafield="APPLICANT_PHONE_FAX_ZY.COUNTRY_CODE" style="">
                                    <select data-datafield="APPLICANT_PHONE_FAX_ZY.COUNTRY_CODE" data-type="SheetDropDownList" id="ctl629122_control3" style=""
                                        data-defaultitems="86" data-queryable="false">
                                    </select></td>
                                <td id="ctl629122_contro1l5" data-datafield="APPLICANT_PHONE_FAX_ZY.AREA_CODE" style="">
                                    <input type="text" data-datafield="APPLICANT_PHONE_FAX_ZY.AREA_CODE" data-type="SheetTextBox" id="ctl629122_control5" style="" onkeyup="this.value=strMaxLength(this.value,'6')" maxlength="6"></td>
                                <td id="ctl629122_control120" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_NUMBER" style="">
                                    <input type="text" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_NUMBER" data-type="SheetTextBox" id="ctl629122_control20" style="width: 92%"
                                        data-regularexpression="/^[1][3,4,5,6,7,8,9][0-9]{9}$/" data-onchange="phone_chg(this)" maxlength="11"></td>
                                <td id="ctl629122_control119" data-datafield="APPLICANT_PHONE_FAX_ZY.EXTENTION_NBR" style="">
                                    <input type="text" data-datafield="APPLICANT_PHONE_FAX_ZY.EXTENTION_NBR" data-type="SheetTextBox" id="ctl629122_control19" style=""
                                        data-regularexpression="/^[+]{0,1}(\d+)$/" data-regularinvalidtext="请输入正整数" maxlength="6"></td>
                                <td id="ctl629122_control14" data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_TYPE_CDE" style="">
                                    <select data-datafield="APPLICANT_PHONE_FAX_ZY.PHONE_TYPE_CDE" data-type="SheetDropDownList" id="ctl629122_control4" style=""
                                        data-masterdatacategory="电话类型" data-queryable="false">
                                    </select></td>

                                <td id="ctl629122_control118" data-datafield="APPLICANT_PHONE_FAX_ZY.ADDRESS_CODE5" style="" class="hidden">
                                    <input type="text" data-datafield="APPLICANT_PHONE_FAX_ZY.ADDRESS_CODE5" data-type="SheetTextBox" id="ctl629122_control18" style=""></td>
        ...
        <div class="divContent" id="div_Detail_WorkInfo" style="padding-right: 0%; display: none">
            ...
            <div class="row tableContent">
                <div id="div386815" class="col-md-12">
                    ...
                    <div id="ctl386784" data-datafield="EMPLOYER_ZY" data-type="SheetDetail" class="" style="" data-filter="{IDENTIFICATION_CODE6}:{IDENTIFICATION_ID}"
                        ...
                        <div id="myTabContent_ctl386784" class="tab-content">
                            <div class="template">
                                <div class="row">
                                    <div class="col-md-8" style="">
                                        ...
                                        <div id="ctl386784_Data5" class="col-md-8" style="width: 83%">
                                            <input type="text" data-datafield="EMPLOYER_ZY.NAME_2" style="" data-type="SheetTextBox" id="ctl386784_control5">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data35" class="col-md-8">
                                            <select data-datafield="EMPLOYER_ZY.BUSINESS_NATURE_CDE" data-type="SheetDropDownList" id="ctl386784_control35" style="" data-displayemptyitem="true" data-queryable="false"
                                                data-schemacode="M_business_type" data-querycode="fun_M_business_type" data-datavaluefield="BUSINESS_TYPE_CDE" data-datatextfield="BUSINESS_TYPE_DSC">
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data9" class="col-md-8">
                                            <select data-datafield="EMPLOYER_ZY.STATE_CDE2" data-type="SheetDropDownList" id="ctl386784_control9" style="" data-displayemptyitem="true"
                                                data-schemacode="area" data-querycode="area_all" data-filter="100000:PARENTID" data-datavaluefield="CODEID" data-datatextfield="CODENAME">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data7" class="col-md-8">
                                            <select data-datafield="EMPLOYER_ZY.CITY_CDE6" data-type="SheetDropDownList" id="ctl386784_control7" style="" data-displayemptyitem="true"
                                                data-schemacode="area" data-querycode="area_all" data-filter="EMPLOYER_ZY.STATE_CDE2:PARENTID" data-datavaluefield="CODEID" data-datatextfield="CODENAME">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div id="ctl386784_Title8" class="col-md-4">
                                            <span id="ctl386784_label8" style="">区县</span>
                                        </div>
                                        <div id="ctl386784_Data8" class="col-md-8">
                                            <select data-datafield="EMPLOYER_ZY.AREA" data-type="SheetDropDownList" id="ctl386784_control8" style="" data-displayemptyitem="true"
                                                data-schemacode="area" data-querycode="area_all" data-filter="EMPLOYER_ZY.CITY_CDE6:PARENTID" data-datavaluefield="CODEID" data-datatextfield="CODENAME">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div id="ctl386784_Title11" class="col-md-4" style="">
                                            <span id="ctl386784_label11" style="">地址一</span>
                                        </div>
                                        <div id="ctl386784_Data11" class="col-md-8" style="">
                                            <input type="text" data-datafield="EMPLOYER_ZY.ADDRESS_ONE_2" style="" data-type="SheetTextBox" id="ctl386784_control11">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data2" class="col-md-8">
                                            <select data-datafield="EMPLOYER_ZY.DESIGNATION_CDE" data-type="SheetDropDownList" id="ctl386784_control2" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data19" class="col-md-4">
                                            <input type="text" data-datafield="EMPLOYER_ZY.TIME_IN_YEAR_2" data-type="SheetTextBox" id="ctl386784_control19" style="width: 50%"
                                                data-regularexpression="/^[+]{0,1}(\d+)$/" data-regularinvalidtext="请输入正整数" maxlength="2">年
                                        </div>
                                        <div id="ctl386784_Data20" class="col-md-4">
                                            <input type="text" data-datafield="EMPLOYER_ZY.TIME_IN_MONTH_2" data-type="SheetTextBox" id="ctl386784_control20" style="width: 50%"
                                ...
                                <div class="row bottom">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data21" class="col-md-8">
                                            <input type="text" data-regularexpression="/^[1][3,4,5,6,7,8,9][0-9]{9}$/" data-datafield="EMPLOYER_ZY.PHONE" data-type="SheetTextBox" id="ctl386784_control21" style="" maxlength="11">
                                        </div>
                                    </div>
                                    <%--<div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data22" class="col-md-8">
                                            <input type="text" data-datafield="EMPLOYER_ZY.FAX" data-type="SheetTextBox" id="ctl386784_control22" style="" onkeyup="this.value=strMaxLength(this.value,'30')" maxlength="30">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data16" class="col-md-8">
                                            <input type="text" data-datafield="EMPLOYER_ZY.POST_CODE_3" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="6" data-type="SheetTextBox" id="ctl386784_control16" style="" data-onchange="postcode_chg(this)">
                                        </div>
                                    </div>--%>
                                </div>
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data1" class="col-md-8">
                                            <input type="text" data-datafield="EMPLOYER_ZY.IDENTIFICATION_CODE6" data-type="SheetTextBox" id="ctl386784_control1" style="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data3" class="col-md-8">
                                            <input type="text" data-datafield="EMPLOYER_ZY.EMPLOYEE_LINE_ID" data-type="SheetTextBox" id="ctl386784_control3" style="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row hidden">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data10" class="col-md-8">
                                            <input type="text" data-datafield="EMPLOYER_ZY.EMPLOYER_TYPE" data-type="SheetTextBox" id="ctl386784_control10" style="" onkeyup="this.value=strMaxLength(this.value,'20')" maxlength="10">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data37" class="col-md-8">
                                            <input type="text" data-datafield="EMPLOYER_ZY.NUMBER_OF_EMPLOYEES" data-type="SheetTextBox" id="ctl386784_control37" style=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl386784_Data18" class="col-md-8">
                                            <input type="text" data-datafield="EMPLOYER_ZY.JOB_DESCRIPTION" style="" data-type="SheetTextBox" id="ctl386784_control18" onkeyup="this.value=strMaxLength(this.value,'100')" maxlength="50">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row hidden">
                                    <div class="col-md-12">
                                        ...
                                        <div id="ctl386784_Data24" class="col-md-8" style="width: 88%">
                                            <input type="text" data-datafield="EMPLOYER_ZY.EMPLOYER_COMMENT" style="" data-type="SheetTextBox" id="ctl386784_control24">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="divContent" id="div_Detail_VEHICLE" style="padding-right: 0%">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl524044_Data9" class="col-md-8">
                                            ...
                                            <select data-datafield="VEHICLE_DETAIL_ZY.CONDITION" data-type="SheetDropDownList" data-queryable="false" id="ctl524044_control9" style="" data-onchange="asset_Condition_Change(this)">
                                                <option value="N">新的</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div id="Div3" class="col-md-4">
                    <input id="inp_Caccountnum" oninput="textnum(this)" type="text" data-onchange="CaccountnumChange(this)" data-datafield="Caccountnum" data-type="SheetTextBox" style="" maxlength="20">
                </div>
            </div>
            <%--<div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div id="ctl508406_Data4" class="col-md-8" style="width: 83%">
                                            <select data-datafield="CONTRACT_DETAIL_ZY.FINANCIAL_PRODUCT_ID" data-type="SheetDropDownList" id="ctl508406_control4" style=""
                                                ...
                                                data-filter="VEHICLE_DETAIL_ZY.CONDITION:asset_condition,APPLICATION_TYPE_CODE:type,bp_id:bp_id,CONTRACT_DETAIL_ZY.FP_GROUP_ID:group_id,VEHICLE_DETAIL_ZY.ASSET_MODEL_CDE:model_cde" data-onchange="fpp_chg(this,'fp');setText(this,'CONTRACT_DETAIL_ZY.FINANCIAL_PRODUCT_NAME')">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div id="ctl508406_Data126" class="col-md-8">
                                            <input type="text" data-datafield="CONTRACT_DETAIL_ZY.ACCESSORY_AMT" disabled data-type="SheetTextBox" id="ctl508406_control126" style=""
                                                data-computationrule="2,SUM({ASSET_ACCESSORY_ZY.PRICE})" data-onchange="fpp_chg(this,'sp')" data-formatrule="{0:N2}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">

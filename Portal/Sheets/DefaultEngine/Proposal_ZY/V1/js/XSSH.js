...
function rsfkClick() {
    ...
    var url = "";
    var idCard = $("div[t='sqr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.ID_CARD_NBR']").text();
    console.log(idCard);
    url = "fkresult.html?id=" + InstanceId + "&repid=" + $.MvcSheetUI.GetControlValue("FK_RECORDID") + "&idCard=" + idCard;
...
function nciicClick() {
    var instanceid = $.MvcSheetUI.SheetInfo.InstanceId;
    var ncurl = "NCIIC_FK.html?instanceid=" + instanceid + "&app_no=" + $.MvcSheetUI.GetControlValue("APPLICATION_NUMBER");
        ...
        success: function (result) {
            ...
            if (result.code == "00") {
                ...
                if (result.sqr) {
                    ...
                    //赋值
                    $("div[t='sqr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.FIRST_THI_NME']").after(span_xm_sqr);
                    $("div[t='sqr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.ID_CARD_NBR']").after(span_sfzh_sqr);
                    $("div[t='sqr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.MARITAL_STATUS_CDE']").after(span_hyzk_sqr);
                }
                //共借人
                if (result.gjr) {
                    var span_xm_gjr = "";//姓名
                    ...
                    //赋值
                    $("div[t='gjr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.FIRST_THI_NME']").after(span_xm_gjr);
                    $("div[t='gjr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.ID_CARD_NBR']").after(span_sfzh_gjr);
                    $("div[t='gjr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.MARITAL_STATUS_CDE']").after(span_hyzk_gjr);
                }
                //担保人
                if (result.dbr) {
                    var span_xm_dbr = "";//姓名
                    ...
                    //赋值
                    $("div[t='dbr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.FIRST_THI_NME']").after(span_xm_gjr);
                    $("div[t='dbr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.ID_CARD_NBR']").after(span_sfzh_gjr);
                    $("div[t='dbr']").eq(0).find("span[data-dtf='APPLICANT_DETAIL_ZY.MARITAL_STATUS_CDE']").after(span_hyzk_gjr);
                }
            }
        },
        //error: function (msg) {
...
function printtext(results) {
    ...
    if (result.code == "00") {
        ...
        //赋值
        $("div[t='sqr']").eq(0).find("span[data-dtf='APPLICANT_PHONE_FAX_ZY.PHONE_NUMBER']").after(span_sqr);
        $("div[t='gjr']").eq(0).find("span[data-dtf='APPLICANT_PHONE_FAX_ZY.PHONE_NUMBER']").after(span_gjr);
        $("div[t='dbr']").eq(0).find("span[data-dtf='APPLICANT_PHONE_FAX_ZY.PHONE_NUMBER']").after(span_dbr);
    }
    //申请人
    //黑名单
...
function showAccessoryLink() {
    var accessory_amt = $.MvcSheetUI.GetControlValue("CONTRACT_DETAIL_ZY.TOTAL_ACCESSORY_AMT", 1);
...
function isred() {
    ...
    //}
    //合同价格
    if ($.MvcSheetUI.GetControlValue("VEHICLE_DETAIL_ZY.ASSET_COST", 1) * 1 >= $.MvcSheetUI.GetControlValue("VEHICLE_DETAIL_ZY.NEW_PRICE", 1) * 1) {
        $.MvcSheetUI.GetElement("VEHICLE_DETAIL_ZY.ASSET_COST", 1).find("label").find("span").css({ "color": "red" });
    }
    //销售价格
    if ($.MvcSheetUI.GetControlValue("VEHICLE_DETAIL_ZY.SALE_PRICE", 1) * 1 >= $("#control309").find("label").find("span").html() * 1) {
        $.MvcSheetUI.GetElement("VEHICLE_DETAIL_ZY.SALE_PRICE", 1).find("label").find("span").css({ "color": "red" });
    }
}
//初审状态下拉框
function bindradio() {
...
$.MvcSheet.Loaded = function (sheetInfo) {
    ...
    if ($.MvcSheetUI.SheetInfo.BizObject.DataItems.APPLICATION_TYPE_CODE.V == "00002") {
        ...
        $.MvcSheetUI.SheetInfo.BizObject.DataItems.APPLICANT_TYPE_ZY.V.R.forEach(function (v, n) {
            if (v.DataItems["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V == "C") {
                isgpd = true;
                return false;
            }
        });
    ...
    if (parseFloat($.MvcSheetUI.GetControlValue("VEHICLE_DETAIL_ZY.NEW_PRICE", 1)) == parseFloat($.MvcSheetUI.GetControlValue("CONTRACT_DETAIL_ZY.TOTAL_ASSET_COST", 1))) {
        $.MvcSheetUI.GetElement("CONTRACT_DETAIL_ZY.TOTAL_ASSET_COST", 1).next().css("color", "red");
    }
...
function get_application_data() {
    ...
    data.APPLICANT_TYPE_ZY.V.R.forEach(function (v, n) {
        var v_main_app = v.DataItems["APPLICANT_TYPE_ZY.MAIN_APPLICANT"].V;
        var v_app_type = v.DataItems["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V;
        var v_app_guart = v.DataItems["APPLICANT_TYPE_ZY.GUARANTOR_TYPE"].V;
        var v_identify_code = v.DataItems["APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1"].V;
        var d = {};
        var type = "";
        ...
        if (type == "I") {
            //个人明细表
            data.APPLICANT_DETAIL_ZY.V.R.forEach(function (v_app_dtl, n_app_dtl) {
                if (v_app_dtl.DataItems["APPLICANT_DETAIL_ZY.IDENTIFICATION_CODE2"].V == v_identify_code) {
                    addobj(d, v_app_dtl.DataItems);
                    return false;
                }
            });
            //工作信息表(只取一条)
            data.EMPLOYER_ZY.V.R.forEach(function (v_employee_dtl, n_employee_dtl) {
                if (v_employee_dtl.DataItems["EMPLOYER_ZY.IDENTIFICATION_CODE6"].V == v_identify_code) {
                    addobj(d, v_employee_dtl.DataItems);
                    return false;
                }
            });
            //联系人明细表(只取一条)
            data.PERSONNAL_REFERENCE_ZY.V.R.forEach(function (v_CONTACT, n_CONTACT) {
                if (v_CONTACT.DataItems["PERSONNAL_REFERENCE_ZY.IDENTIFICATION_CODE10"].V == v_identify_code) {
            ...
            //机构明细表
            data.COMPANY_DETAIL_ZY.V.R.forEach(function (v_company_dtl, n_company_dtl) {
                if (v_company_dtl.DataItems["COMPANY_DETAIL_ZY.IDENTIFICATION_CODE3"].V == v_identify_code) {
        ...
        //地址明细表(只取一条)
        data.ADDRESS_ZY.V.R.forEach(function (v_ADDRESS, n_ADDRESS) {
            if (v_ADDRESS.DataItems["ADDRESS_ZY.IDENTIFICATION_CODE4"].V == v_identify_code) {
                addobj(d, v_ADDRESS.DataItems);
                //电话号码,最取一条
                data.APPLICANT_PHONE_FAX_ZY.V.R.forEach(function (v_APPLICANT_PHONE_FAX, n_APPLICANT_PHONE_FAX) {
                    if (v_APPLICANT_PHONE_FAX.DataItems["APPLICANT_PHONE_FAX_ZY.ADDRESS_CODE5"].V == v_ADDRESS.DataItems["ADDRESS_ZY.ADDRESS_CODE"].V
                        && v_APPLICANT_PHONE_FAX.DataItems["APPLICANT_PHONE_FAX_ZY.IDENTIFICATION_CODE5"].V == v_identify_code) {
    ...
    result.forEach(function (v, n) {
        //个人
        ddl_Data.APPLICANT_DETAIL_ZY.forEach(function (v_app, n_app) {
            if (v_app.IDENTIFICATION_CODE == v["APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1"].V) {
                for (var k in v_app) {
        ...
        //机构
        ddl_Data.COMPANY_DETAIL_ZY.forEach(function (v_app, n_app) {
            if (v_app.IDENTIFICATION_CODE == v["APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1"].V) {
                for (var k in v_app) {
                    if (k != "IDENTIFICATION_CODE") {
                        if (v[k].V == v_app[k].Code) {
        ...
        //地址
        ddl_Data.ADDRESS_ZY.forEach(function (v_app, n_app) {
            if (v_app.IDENTIFICATION_CODE == v["APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1"].V &&
                v_app.ADDRESS_CODE == v["ADDRESS_ZY.ADDRESS_CODE"].V) {
                for (var k in v_app) {
        ...
        //电话
        ddl_Data.APPLICANT_PHONE_FAX_ZY.forEach(function (v_app, n_app) {
            if (v_app.IDENTIFICATION_CODE == v["APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1"].V &&
                v_app.ADDRESS_CODE == v["ADDRESS_ZY.ADDRESS_CODE"].V &&
                v_app.PHONE_SEQ_ID == v["APPLICANT_PHONE_FAX_ZY.PHONE_SEQ_ID"].V) {
                for (var k in v_app) {
        ...
        //工作
        ddl_Data.EMPLOYER_ZY.forEach(function (v_app, n_app) {
            if (v_app.IDENTIFICATION_CODE == v["APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1"].V &&
                v_app.EMPLOYEE_LINE_ID == v["EMPLOYER_ZY.EMPLOYEE_LINE_ID"].V) {
                for (var k in v_app) {
        ...
        //联系人
        ddl_Data.PERSONNAL_REFERENCE_ZY.forEach(function (v_app, n_app) {
            if (v_app.IDENTIFICATION_CODE == v["APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1"].V &&
                v_app.LINE_ID == v["PERSONNAL_REFERENCE_ZY.LINE_ID10"].V) {
                for (var k in v_app) {
...
function show_borrow_tab() {
    //增加PCM客户测算
    var loanAmt = $.MvcSheetUI.GetControlValue("CONTRACT_DETAIL_ZY.AMOUNT_FINANCED", 1);   //放款金额
    var periods = $.MvcSheetUI.GetControlValue("CONTRACT_DETAIL_ZY.LEASE_TERM_IN_MONTH", 1);           //期数
    var dzcarloan = "";                             //东正车贷月应还款额

    //判断是否有共借人
    var hasGjr = false;
    $($.MvcSheetUI.SheetInfo.BizObject.DataItems.APPLICANT_TYPE_ZY.V.R).each(function (n, v) {
        if (v.DataItems["APPLICANT_TYPE_ZY.MAIN_APPLICANT"].V == null) {//非主借人
            if (v.DataItems["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V == "I") {//共借人
                hasGjr = true;
                return false;
            }
        }
    ...
    data.forEach(function (v, n) {
        var id = v["APPLICANT_TYPE_ZY.ObjectID"].V.trim();
        var type = v["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V;
        var g_type = v["APPLICANT_TYPE_ZY.GUARANTOR_TYPE"].V;
        var main_type = v["APPLICANT_TYPE_ZY.MAIN_APPLICANT"].V;
        var name = "";
        var type_name = "";
        var t = "";
        if (main_type == "Y") {
        ...
        //PCM 客户测算
        if (app_type == "00001" && v["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V == "I") {
            getCustomerInfo(type, v["APPLICANT_TYPE_ZY.NAME1"].V, type_name, $.MvcSheetUI.GetControlValue("APPLICATION_NUMBER"), v["APPLICANT_DETAIL_ZY.ID_CARD_NBR"].V, dzcarloan);
        }

        name = type_name + ":" + v["APPLICANT_TYPE_ZY.NAME1"].V;
        var is_view = v["APPLICANT_TYPE_ZY.IS_INACTIVE_IND"].V == "T" ? "隐藏" : "显示";
        if (is_view == "显示") {
            //2019-01-28号：只根据人员关系表中的显示及隐藏来控制，和Spouse无关，Spouse表示是否发送给上海银行；
            //if (v["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V == "I" && v["APPLICANT_DETAIL_ZY.SPOUSE_IND"] && v["APPLICANT_DETAIL_ZY.SPOUSE_IND"].V) {
            //    is_view = "隐藏";
            //}
        }
        //1.生成Tab标签
        ...
        if (type == "I" || g_type == "I") {
            ...
            if ($.inArray("001", acls) > -1) {
                $("#aclickh").append("<a href=\"javascript:void(0);\" class=\"role\" onclick=\"pbocClick('" + v["APPLICANT_DETAIL_ZY.FIRST_THI_NME"].V + "','" + v["APPLICANT_DETAIL_ZY.ID_CARD_TYP"].V + "','" + v["APPLICANT_DETAIL_ZY.ID_CARD_NBR"].V + "');\">" + type_name + "</a>");
            }
        }
        //机构
        ...
        if (main_type == "Y") {  //申请人:个人
            if (type == "I") {
                //不显示关系
                $(row).find("span[data-dtf='APPLICANT_DETAIL_ZY.GUARANTOR_RELATIONSHIP_CDE']").parent().parent().hide();
            }
        }
        else if (type == "I") {//共借人-个人
            //显示是否是配偶
            $(row).find("span[data-dtf='APPLICANT_DETAIL_ZY.SPOUSE_IND']").parent().parent().removeClass("hidden");
        }
        ...
        if (main_type == "Y") {
            $(row).find("#bankcard_report_link").removeClass("hidden").find("a").unbind("click").bind("click", function () {
                queryBankCardReport(v["APPLICANT_DETAIL_ZY.FIRST_THI_NME"].V, v["APPLICANT_DETAIL_ZY.ID_CARD_NBR"].V);
            });
        }

        //先注释
        if ((g_type == "I" || type == "I") && v["APPLICANT_DETAIL_ZY.ID_CARD_TYP"].V == "居民身份证") {
            $(row).find("#td_report_link").removeClass("hidden").find("a").unbind("click").bind("click", function () {
                queryTdReport(v["APPLICANT_DETAIL_ZY.ID_CARD_NBR"].V);
            });
        }
        ...
        $(row).find("[data-dtf]").each(function (n_span, v_span) {
            ...
            if (dtf != "" && v[dtf]) {
                ...
                if ($(v_span).attr("data-fmt") && $(v_span).attr("data-fmt") != "") {
                    ...
                    v_val = v[dtf].V;
                    if (dtf == "EMPLOYER_ZY.NAME_2") {
                        var app_no = $.MvcSheetUI.GetControlValue("APPLICATION_NUMBER");
                        $.ajax({
                            url: "/Portal/Proposal/GetCompanyOrderList?companyName=" + v_val + "&application_number=" + app_no + "&t=" + new Date().getTime(),
                            data: "",
                            type: "GET",
                            dataType: "json",
                            async: true,
...
function queryBankCardReport(name, idCard) {
    ...
    var InstanceId = $.MvcSheetUI.SheetInfo.InstanceId;
    var url = "bankcardinforesult.html?id=" + InstanceId + "&name=" + name + "&idCard=" + idCard;
...
function getCompanyOrderList(target) {
    ...
    $("#dealersInfo").empty();
    $.ajax({
        url: "/Portal/Proposal/GetCompanyOrderList?companyName=" + companyName + "&application_number=" + app_no+"&t=" + new Date().getTime(),
        data: "",
        type: "GET",
        dataType: "json",
        async: true,
...
function queryFkPBOC() {
    ...
    $.ajax({
        url: "/Portal/Api/QueryPBOCReport?InstanceId=" + instanceId + "&ApplicationNumber=" + applicationNumber,
        data: "",
        type: "GET",
        dataType: "json",
        async: true,

...
function GetAddressValueByIdentifyCode(id, field, text_Or_value) {
    return GetDetailValueByIdentifyCode("ADDRESS_ZY", "IDENTIFICATION_CODE4", id, field, text_Or_value);
}
//获取申请人的值
function GetApplicantDetailValueByIdentifyCode(id, field, text_Or_value) {
    return GetDetailValueByIdentifyCode("APPLICANT_DETAIL_ZY", "IDENTIFICATION_CODE2", id, field, text_Or_value);
}
//获取公司的值
function GetCompanyDetailValueByIdentifyCode(id, field, text_Or_value) {
    return GetDetailValueByIdentifyCode("COMPANY_DETAIL_ZY", "IDENTIFICATION_CODE3", id, field, text_Or_value);
}
//获取电话的值
function GetPhoneFaxValueByIdentifyCode(id, field, text_Or_value) {
    return GetTableValueByIdentifyCode("APPLICANT_PHONE_FAX_ZY", "IDENTIFICATION_CODE5", id, field, text_Or_value);
}
//获取工作的值
function GetEmployValueByIdentifyCode(id, field, text_Or_value) {
    return GetDetailValueByIdentifyCode("EMPLOYER_ZY", "IDENTIFICATION_CODE6", id, field, text_Or_value);
}
...
function delete_Individual(id) {
    deleteRowByIdentifyCode("APPLICANT_DETAIL_ZY", "IDENTIFICATION_CODE2", id, "div");
}

//删除机构表中的行
function delete_Company(id) {
    deleteRowByIdentifyCode("COMPANY_DETAIL_ZY", "IDENTIFICATION_CODE3", id, "div");
}

//删除地址表中的行
function delete_Address(id) {
    deleteRowByIdentifyCode("ADDRESS_ZY", "IDENTIFICATION_CODE4", id, "div");
}

//删除电话表中的行
function delete_Phone(id, address_code) {
    if (address_code == null || address_code == undefined) {
        deleteRowByIdentifyCode("APPLICANT_PHONE_FAX_ZY", "IDENTIFICATION_CODE5", id, "table");
    }
    else {
        var paras = {};
        paras["IDENTIFICATION_CODE5"] = id;
        paras["ADDRESS_CODE5"] = address_code;
        deleteRow("APPLICANT_PHONE_FAX_ZY", paras, "table");
    }
}

//删除联系人中的行
function delete_Contact(id) {
    deleteRowByIdentifyCode("PERSONNAL_REFERENCE_ZY", "IDENTIFICATION_CODE10", id, "div");
}

//删除工作中的行
function delete_WorkExp(id) {
    deleteRowByIdentifyCode("EMPLOYER_ZY", "IDENTIFICATION_CODE6", id, "div");
}
...
function getApplicantUserInfo() {
    var d = readMessageByDF("APPLICATION_ZY", $.MvcSheetUI.SheetInfo.InstanceId, "rsjson");
...
function getApplicantUserInfoByBizObject() {
    ...
    $.MvcSheetUI.SheetInfo.BizObject.DataItems.APPLICANT_TYPE_ZY.V.R.forEach(function (v, n) {
        var id_number = v.DataItems["APPLICANT_TYPE_ZY.IDENTIFICATION_CODE1"].V;
        
        if (v.DataItems["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V == "I" ||
                v.DataItems["APPLICANT_TYPE_ZY.GUARANTOR_TYPE"].V == "I") {
            var name_field = "APPLICANT_DETAIL_ZY.FIRST_THI_NME";
            var id_field = "APPLICANT_DETAIL_ZY.ID_CARD_NBR";
            $.MvcSheetUI.SheetInfo.BizObject.DataItems.APPLICANT_DETAIL_ZY.V.R.forEach(function (app_dtl, app_num) {
                if (app_dtl.DataItems["APPLICANT_DETAIL_ZY.IDENTIFICATION_CODE2"].V == id_number) {
                    if (id_number == "1") {
                        d["sqr_name"] = app_dtl.DataItems[name_field].V;
                        d["sqr_id"] = app_dtl.DataItems[id_field].V;
                    }
                    else {
                        if (v.DataItems["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V == "I" && d["gjr_name"] == undefined) {
                            d["gjr_name"] = app_dtl.DataItems[name_field].V;
                            d["gjr_id"] = app_dtl.DataItems[id_field].V;
                        }
                        else if (v.DataItems["APPLICANT_TYPE_ZY.GUARANTOR_TYPE"].V == "I" && d["dbr_name"] == undefined) {
        ...
        else if (v.DataItems["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V == "C" ||
            v.DataItems["APPLICANT_TYPE_ZY.GUARANTOR_TYPE"].V == "C") {
            var name_field = "COMPANY_DETAIL_ZY.COMPANY_THI_NME";
            var sts_field = "COMPANY_DETAIL_ZY.COMPANY_STS";
            var org_code_field = "COMPANY_DETAIL_ZY.ORGANIZATION_CDE";
            $.MvcSheetUI.SheetInfo.BizObject.DataItems.COMPANY_DETAIL_ZY.V.R.forEach(function (app_dtl, app_num) {
                if (app_dtl.DataItems["COMPANY_DETAIL_ZY.IDENTIFICATION_CODE3"].V == id_number) {
                    if (id_number == "1") {
                        ...
                        if (v.DataItems["APPLICANT_TYPE_ZY.APPLICANT_TYPE"].V == "C" && d["gjr_company_name"] == undefined) {
                        ...
                        else if (v.DataItems["APPLICANT_TYPE_ZY.GUARANTOR_TYPE"].V == "C" && d["dbr_company_name"] == undefined) {

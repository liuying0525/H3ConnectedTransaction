<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mortgage.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.Mortgage" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<asp:Content ID="master" ContentPlaceHolderID="masterContent" runat="Server">
    ...
    <script type="text/javascript" src="js/common.js?v=<%=DateTime.Now.ToString("yyyyMMdd") %>007"></script>
    ...
    <div class="panel-body sheetContainer">
        ...
        <div class="nav-icon fa  fa-chevron-down bannerTitle" onclick="hidediv('divattachment',this)">
            <label id="Label1" data-en_us="Sheet information">抵押</label>
        </div>
        <div class="divContent" id="divattachment">
            <div class="row">
                <div id="title368" class="col-md-2">
                    <span id="Label348" data-type="SheetLabel"  style="">贷款合同</span>
                </div>
                <div id="control368" class="col-md-10">
                    <div id="Control345" class="show-download" data-datafield="DKHT" data-type="SheetAttachment" data-picturecompress="true" style="" data-fileextensions=".pdf">
                    </div>
                </div>
            </div>
            <div class="row">
                <div id="title367" class="col-md-2">
                    <span id="Label347" data-type="SheetLabel"  style="">抵押资料</span>
                </div>
                <div id="control367" class="col-md-10">
                    <div id="Control347" class="show-download" data-datafield="qifiles" data-type="SheetAttachment" data-picturecompress="true" style="" data-fileextensions=".jpg,.png,.jpeg">
                    </div>
                </div>
            </div>
            <div class="row">
                <div id="title365" class="col-md-2">
                    <span id="Label345" data-type="SheetLabel"  style="">是否已安装GPS</span>
                </div>
                <div id="control365" class="col-md-4">
                    
                     <select data-datafield="gpsInstallStatus" data-type="SheetDropDownList" id="ctl604410_control27" >
                        <option></option>
            ...
            <div class="row">
                <div id="title363" class="col-md-2">
                    <span id="Label343" data-type="SheetLabel"  style="">抵押凭证</span>
                </div>
                <div id="control363" class="col-md-10">
                    <div id="Control343" class="show-download" data-datafield="diyafiles" data-type="SheetAttachment" data-picturecompress="true" style="" data-fileextensions=".jpg,.png,.jpeg">
                    </div>
                </div>
            </div>
            <div class="row hidden">
                <div id="title364" class="col-md-2">
                    <span id="Label344" data-type="SheetLabel"  style="">抵押审核</span>
                </div>
                <div id="control364" class="col-md-10">
                    <div id="Control344" data-datafield="dysp" data-type="SheetRadioButtonList"  style="" data-defaultselected="false" data-defaultitems="通过;拒绝" >
                    </div>
                </div>
            </div>
            <div class="row">
                <div id="title366" class="col-md-2">
                    <span id="Label346" data-type="SheetLabel" style="">抵押审核意见</span>
                </div>
                <div id="control366" class="col-md-4">
                    <div id="Control346" data-datafield="dyspyj" data-type="SheetComment" style="" class=""></div>
                </div>
            </div>
        </div>

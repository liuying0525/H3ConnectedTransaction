...
<asp:Content ID="master" ContentPlaceHolderID="masterContent" runat="Server">
    ...
    <script type="text/javascript" src="js/TemplatePrint.js?v=<%=DateTime.Now.ToString("yyyyMMdd") %>"></script>
        ...
        <div class="divContent" id="divattachment">
            ...
            <div class="row hidden">
                <div id="title383" class="col-md-2">
                    <span id="Label353" data-type="SheetLabel" style="">贷款合同(.pdf)</span>
                </div>
                <div id="control383" class="col-md-10">
                    <%--<div id="Control353" data-datafield="DKHT" data-type="SheetAttachment" data-picturecompress="true" style="" data-fileextensions=".pdf"></div>--%>
                    <input id="Control120" type="text" data-datafield="DKHT_FileName" data-type="SheetTextBox" style="" class="">
                </div>
            </div>

            <div class="row hidden">
                <div id="title384" class="col-md-2">
                    <span id="Label354" data-type="SheetLabel" style="">抵押办理资料</span>
                </div>
                <div id="control384" class="col-md-10">
                    <%--<div id="Control353" data-datafield="DKHT" data-type="SheetAttachment" data-picturecompress="true" style="" data-fileextensions=".pdf"></div>--%>
                    <input id="Control121" type="text" data-datafield="qifiles" data-type="SheetTextBox" style="" class="">
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $.MvcSheet.Validate = function () {
            var DKHT_FileName = $.MvcSheetUI.GetControlValue("DKHT_FileName", 1);
            if (DKHT_FileName == "" || DKHT_FileName == null) {
                shakeMsg("请先打印合同");
                return false;
            }
        }

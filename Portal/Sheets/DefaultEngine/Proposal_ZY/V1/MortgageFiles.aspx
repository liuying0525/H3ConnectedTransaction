<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MortgageFiles.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.MortgageFiles" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<asp:Content ID="master" ContentPlaceHolderID="masterContent" runat="Server">
    ...
    <div class="panel-body sheetContainer">
        ...
        <div class="nav-icon fa  fa-chevron-down bannerTitle" onclick="hidediv('divattachment',this)">
            <label id="Label1" data-en_us="Sheet information">抵押资料</label>
        </div>
        <div class="divContent" id="divattachment">
            <div class="row">
                <div id="title364" class="col-md-2">
                    <span id="Label345" data-type="SheetLabel"  style="">贷款合同</span>
                </div>
            ...
            <div class="row">
                <div id="title363" class="col-md-2">
                    <span id="Label343" data-type="SheetLabel"  style="">抵押资料</span>
                </div>
                <div id="control363" class="col-md-10">
                    <div id="Control343" class="show-download" data-datafield="qifiles" data-type="SheetAttachment" data-picturecompress="true" style="" data-fileextensions=".jpg,.png,.jpeg">
                    </div>
                </div>
            </div>

...
function OnComplete3(str,doc)
{
    ...
    TANGER_OCX_OBJ.ActiveDocument.ActiveWindow.ActivePane.DisplayRulers = false;//隐藏标尺
		TANGER_OCX_OBJ.SetReadOnly(true,"ewqe31");
...
if (browser=="IE"){
	...
	if(window.navigator.platform=="Win32"){
		...
		document.write('<param name="ProductCaption" value="上海东正汽车金融有限责任公司"> ');
		document.write('<param name="ProductKey" value="FD3A13897FFFC3AE0901FD19D2812CC84993994B">');
		document.write('<param name="NoExpireKey" value="3AD66017317DA7D9F1405272C2153889">');
		...
		document.write('<param name="Caption" value="预览">   ');
	...
	if(window.navigator.platform=="Win64"){
		...
		document.write('_ProductCaption="上海东正汽车金融有限责任公司"');
		document.write('_ProductKey="FD3A13897FFFC3AE0901FD19D2812CC84993994B"');
		document.write('_NoExpireKey="3AD66017317DA7D9F1405272C2153889"');
		...
		document.write('<SPAN STYLE="color:red">尚未安装NTKO Web FireFox跨浏览器插件。请点击<a href="/Portal/Sheets/NTKO/officecontrol/上海东正汽车金融有限责任公司.exe">安装组件</a></SPAN>   ');
		document.write('</object>   ');
		...
		document.write('_MenuButtonStyle="7"   ');
		document.write('_WebUserName="NTKO"   ');
		document.write('_Caption="预览">    ');
		document.write('<SPAN STYLE="color:red">尚未安装NTKO Web Chrome跨浏览器插件。请点击<a href="/Portal/Sheets/NTKO/officecontrol/上海东正汽车金融有限责任公司.exe">安装组件</a></SPAN>   ');
		document.write('</object>');
	}else if (Sys.opera){

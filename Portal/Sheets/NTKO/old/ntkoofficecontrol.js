...
var codebase = "1officecontrol/OfficeControl.cab#version=5,0,2,9";
var codebase64 = "1officecontrol/OfficeControlx64.cab#version=5,0,2,9";
if (browser == "IE") {
    ...
    if (window.navigator.platform == "Win32") {
        ...
        document.write('<param name="Caption" value="打印演示">   ');
        document.write('<SPAN STYLE="color:red">不能装载文档控件。请在检查浏览器的选项中检查浏览器的安全设置。请点击<a href="officecontrol/NTKO OFFICE安装包.exe">安装组件</a></SPAN>   ');
    ...
    document.write('<SPAN STYLE="color:red">尚未安装NTKO Web FireFox跨浏览器插件。请点击<a href="officecontrol/NTKO OFFICE安装包.exe">安装组件</a></SPAN>   ');
    document.write('</object>   ');
    ...
    document.write('_MenuButtonStyle="7"   ');
    document.write('_WebUserName="NTKO"   ');
    document.write('_Caption="打印演示">    ');
    document.write('<SPAN STYLE="color:red">尚未安装NTKO Web Chrome跨浏览器插件。请点击<a href="officecontrol/NTKO OFFICE安装包.exe">安装组件</a></SPAN>   ');
    document.write('</object>');
} else if (Sys.opera) {

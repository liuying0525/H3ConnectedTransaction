<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sccc.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.H3V10_Qianc.Sccc" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<div style="text-align: center;" class="DragContainer">
	<label id="lblTitle" class="panel-title">回国</label>
</div>
	...
	<div class="divContent">
		<div class="row">
			...
			<div id="divOriginateDate" class="col-md-4">
				<label id="lblOriginateDate" data-type="SheetLabel" data-datafield="OriginateTime" data-bindtype="OnlyData"></label>
			</div>
		</div>
		<div class="row">
...
<span class="OnlyDesigner">Originator.OUName</span>
					...
					<select data-datafield="Originator.OUName" data-type="SheetOriginatorUnit" id="ctlOriginaotrOUName" class="">
					</select>
				</div>
		...
		<div class="divContent" id="divSheet">
			<div class="row">
				<div id="title1" class="col-md-2">
					<span id="Label11" data-type="SheetLabel" data-datafield="asda">adasda</span>
				</div>
				<div id="control1" class="col-md-4">
					<input id="Control11" type="text" data-datafield="asda" data-type="SheetTextBox">
				</div>
				<div id="space2" class="col-md-2">
				<label data-datafield="aaaaaa" data-type="SheetLabel" id="ctl776100" class="">aaaaaaaa</label></div>
				<div id="spaceControl2" class="col-md-4">
				<input type="text" data-datafield="aaaaaa" data-type="SheetTextBox" id="ctl812271" class=""></div>
			</div>
		</div>
	</div>
</asp:Content>
angular.module('starter', ['ionic', 'starter.controllers', 'starter.services', 'starter.directives', 'ngCordova','ion-datetime-picker'])
      ...
      // Each state's controller can be found in controllers.js
        $stateProvider
          ...
          //底部
           ...
           .state('sheetUser', {
               url: '/sheetUser',
               templateUrl: 'templates/sheetUser.html',

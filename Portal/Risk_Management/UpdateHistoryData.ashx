<%@ WebHandler Language="C#" Class="UpdateHistoryData" %>
...
public class UpdateHistoryData : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string result = HttpPost("http://localhost:8011/Portal/" + (string.IsNullOrEmpty(objectid) ? "CRM_To_H3_AccedeCompany/Index" : "CRM_To_H3_ModifyInfomationOfAccedeCompany/Index"), content);// wangxg 19.7

...
public class CRM_To_H3_ModifyInfomationOfAccedeCompany : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            dataList = GetDataItemParam(jsonData);
            //DataTable table = AppUtility.Engine.EngineConfig.CommandFactory.CreateCommand().ExecuteDataTable("SELECT * FROM I_ALLOWIN WHERE CRMDEALERID='" + jsonData["third_system_no"] + "'");
            ...
            if (instanceData != null && instanceData.BizObject.ValueTable.Count > 0)
            {
                ...
                if(jsonData["accedecontent"].ToString().IndexOf("classType".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "Type", ItemValue = instanceData.BizObject.ValueTable["Type"] + string.Empty });
                ...
                //if(jsonData["accedecontent"].ToString().IndexOf("SixBankFlow".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "SixBankFlow", ItemValue = instanceData.BizObject.ValueTable["SixBankFlow"] + string.Empty });
                //if(jsonData["accedecontent"].ToString().IndexOf("Profits".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "Profits", ItemValue = instanceData.BizObject.ValueTable["Profits"] + string.Empty });
                //if(jsonData["accedecontent"].ToString().IndexOf("IsBank".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "IsBank", ItemValue = instanceData.BizObject.ValueTable["IsBank"] + string.Empty });
                ...
                if(jsonData["accedecontent"].ToString().IndexOf("Total".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "Total", ItemValue = instanceData.BizObject.ValueTable["Total"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("ShareRatio".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "ShareRatio", ItemValue = instanceData.BizObject.ValueTable["ShareRatio"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("Area".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "Area", ItemValue = instanceData.BizObject.ValueTable["Area"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("FinancialDepartment".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "FinancialDepartment", ItemValue = instanceData.BizObject.ValueTable["FinancialDepartment"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("MortgageConfirmation".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "MortgageConfirmation", ItemValue = instanceData.BizObject.ValueTable["MortgageConfirmation"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("XSQK".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "XSQK", ItemValue = instanceData.BizObject.ValueTable["XSQK"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("ZXQK".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "ZXQK", ItemValue = instanceData.BizObject.ValueTable["ZXQK"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("SXQK".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "SXQK", ItemValue = instanceData.BizObject.ValueTable["SXQK"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("BusinessLife".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "BusinessLife", ItemValue = instanceData.BizObject.ValueTable["BusinessLife"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("Seniority".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "Seniority", ItemValue = instanceData.BizObject.ValueTable["Seniority"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("Administrative".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "Administrative", ItemValue = instanceData.BizObject.ValueTable["Administrative"] + string.Empty });
                if(jsonData["accedecontent"].ToString().IndexOf("Lease".ToLower()) < 0) dataList.Add(new DataItemParam { ItemName = "Lease", ItemValue = instanceData.BizObject.ValueTable["Lease"] + string.Empty });
    ...
    /// <returns></returns>
    public List<DataItemParam> GetDataItemParam(JObject jsonData)
    {
        List<DataItemParam> dataList = new List<DataItemParam>();
        string changeField = "";
        ...
        foreach (var item in jsonData["accedecontent"])
        {
            switch (item["code"].ToString())
            {
                ...
                case "classtype":dataList.Add(new DataItemParam { ItemName = "Type", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "Type" : ",Type") + ":" + item["name"];break;
                ...
                case "total": dataList.Add(new DataItemParam { ItemName = "Total", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "Total" : ",Total") + ":" + item["name"];break;
                case "shareratio": dataList.Add(new DataItemParam { ItemName = "ShareRatio", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "ShareRatio" : ",ShareRatio") + ":" + item["name"];break;
                case "area": dataList.Add(new DataItemParam { ItemName = "Area", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "Area" : ",Area") + ":" + item["name"];break;
                case "financialdepartment": dataList.Add(new DataItemParam { ItemName = "FinancialDepartment", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "FinancialDepartment" : ",FinancialDepartment") + ":" + item["name"];break;
                case "mortgageconfirmation": dataList.Add(new DataItemParam { ItemName = "MortgageConfirmation", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "MortgageConfirmation" : ",MortgageConfirmation") + ":" + item["name"];break;
                case "xsqk": dataList.Add(new DataItemParam { ItemName = "XSQK", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "XSQK" : ",XSQK") + ":" + item["name"];break;
                case "zxqk": dataList.Add(new DataItemParam { ItemName = "ZXQK", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "ZXQK" : ",ZXQK") + ":" + item["name"];break;
                case "sxqk": dataList.Add(new DataItemParam { ItemName = "SXQK", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "SXQK" : ",SXQK") + ":" + item["name"];break;
                case "businesslife": dataList.Add(new DataItemParam { ItemName = "BusinessLife", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "BusinessLife" : ",BusinessLife") + ":" + item["name"];break;
                case "seniority": dataList.Add(new DataItemParam { ItemName = "Seniority", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "Seniority" : ",Seniority") + ":" + item["name"];break;
                case "administrative": dataList.Add(new DataItemParam { ItemName = "Administrative", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "Administrative" : ",Administrative") + ":" + item["name"];break;
                case "lease": dataList.Add(new DataItemParam { ItemName = "Lease", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "Lease" : ",Lease") + ":" + item["name"];break;
                case "sixbankflow": dataList.Add(new DataItemParam { ItemName = "SixBankFlow", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "SixBankFlow" : ",SixBankFlow") + ":" + item["name"];break;
                case "profits": dataList.Add(new DataItemParam { ItemName = "Profits", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "Profits" : ",Profits") + ":" + item["name"];break;
                case "isbank": dataList.Add(new DataItemParam { ItemName = "IsBank", ItemValue = item["value"].ToString() }); changeField += (changeField == "" ? "IsBank" : ",IsBank") + ":" + item["name"];break;

                //case "total": changeField += (changeField == "" ? "Total" : ",Total") + ":" + item["name"];break;

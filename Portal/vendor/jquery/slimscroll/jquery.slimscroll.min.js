	...
	jQuery.fn.extend({
		slimScroll: function(h) {
			...
			this.each(function() {
				...
				function C() {
					window.addEventListener ? (this.addEventListener("DOMMouseScroll", r), this.addEventListener("mousewheel", r), this.addEventListener("MozMousePixelScroll", r)) : document.attachEvent("onmousewheel")
				}

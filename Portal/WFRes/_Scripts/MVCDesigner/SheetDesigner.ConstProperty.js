...
var HtmlModels = {
    ...
    SheetDetail: "<div data-datafield=\"{datafield}\" data-type=\"SheetDetail\"></div>",//chenghs 2018-04-09
...
var DesignerControls = {
    ...
    SheetDetail: {//chenghs
        FullName: SheetControls.SheetDetail,
...
var DataLogicTypes = {
    ...
    SubTable: {
        ...
        ControlRange: [
            ...
            DesignerControls.SheetDetail//chenghs
        ]
    },
    //XML
    Xml: {
    ...
    Object: {
        Type: 40,
        DisplayName: '业务对象',
        ControlRange: [DesignerControls.SheetLabel, DesignerControls.SheetGridView, DesignerControls.SheetDetail]//chenghs
    },
    // 业务对象数组
    SubTable: {
        Type: 41,

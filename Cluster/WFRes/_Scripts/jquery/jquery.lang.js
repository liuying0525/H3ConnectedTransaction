(function ($) {
    ...
    // 语言对象
    $.Languages = loadJSON("Cluster_LanguageData_" + getCurrentLanguage(), _CLUSTERROOT_GLOBAL + "/lang/" + getCurrentLanguage() + ".js");

    // 控制器对象
    $.Controller = loadJSON("Cluster_ControllerData", _CLUSTERROOT_GLOBAL+"/lang/ControllerData.js");

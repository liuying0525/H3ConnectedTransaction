...
namespace DongZheng.H3.WebApi.Controllers.Ajax
{
    [ValidateInput(false)]
    [Xss]
    public class DelScoringRankController : OThinker.H3.Controllers.ControllerBase
    {
        ...
        public void Index()
        {
            ...
            using (System.IO.StreamReader sr = new System.IO.StreamReader(s))
            {
                ...
                if (!string.IsNullOrWhiteSpace(sql))
                    AppUtility.Engine.EngineConfig.CommandFactory.CreateCommand().ExecuteNonQuery("UPDATE  C_GRADE SET STATES=0" + sql);
            }
        }

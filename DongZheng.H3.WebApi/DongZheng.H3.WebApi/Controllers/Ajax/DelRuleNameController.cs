...
namespace DongZheng.H3.WebApi.Controllers.Ajax
{
    [ValidateInput(false)]
    [Xss]
    public class DelRuleNameController : OThinker.H3.Controllers.ControllerBase
    {
        ...
        public void Index()
        {
            ...
            using (System.IO.StreamReader sr = new System.IO.StreamReader(s))
            {
                ...
                if (!string.IsNullOrWhiteSpace(sql))
                    AppUtility.Engine.EngineConfig.CommandFactory.CreateCommand().ExecuteNonQuery("UPDATE  C_RULENAME SET STATE=0" + sql);
            }
        }

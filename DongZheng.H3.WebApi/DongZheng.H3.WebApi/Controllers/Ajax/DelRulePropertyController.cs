...
namespace DongZheng.H3.WebApi.Controllers.Ajax
{
    [ValidateInput(false)]
    [Xss]
    public class DelRulePropertyController : CustomController
    {
        ...
        public void Index()
        {
            ...
            using (System.IO.StreamReader sr = new System.IO.StreamReader(s))
            {
                ...
                if (!string.IsNullOrWhiteSpace(sql))
                    AppUtility.Engine.EngineConfig.CommandFactory.CreateCommand().ExecuteNonQuery("UPDATE  C_RULEPROPERTY SET STATE=0" + sql);
            }
        }

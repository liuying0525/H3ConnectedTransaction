...
namespace DongZheng.H3.WebApi.Controllers.Ajax.PusherHelper
{
    [ValidateInput(false)]
    [Xss]
    public class GetPusherInfoController : OThinker.H3.Controllers.ControllerBase
    {
        ...
        public void Index()
        {
            ...
            try
            {
                ...
                {
                    ret.Add("Result", 0);
                    ret.Add("ServiceState", (int)ServiceState.NotExists);
                }
                else
                {
                    ret.Add("Result", 0);
                    ...
                    {
                        ret.Add("ServiceState", (int)ServiceState.Running);
                    }
                    else
                    {
                        ret.Add("ServiceState", (int)ServiceState.Stoped);
                    }

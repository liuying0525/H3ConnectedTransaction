...
namespace DongZheng.H3.WebApi.Controllers.ProcessCenter
{
    [ValidateInput(false)]
    [Xss]
    public class AutoAllocationOrderAuthController : CustomController
    {
...
//        }
    ...
    public class AllocationOrderAuth
    {
        /// <summary>
        /// 日志文件名称
        /// </summary>
        ...
        /// <returns></returns>
        public AllocationOrderRule ToRule(DataRow row)
        {
            var r = typeof(AllocationOrderRule);
            ...
            return (AllocationOrderRule)obj;
        }
